            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.allRawNodesJsons = new HashMap<String,String>(2*_map36.size);
                String _key37;
                String _val38;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.buildFileDependents = new HashMap<String,List<String>>(2*_map40.size);
                String _key41;
                List<String> _val42;
                for (int _i43 = 0; _i43 < _map40.size; ++_i43)
                {
                  _key41 = iprot.readString();
                  {
                    ...
                    _val42 = new ArrayList<String>(_list44.size);
                    String _elem45;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.buildFileEnv = new HashMap<String,Map<String,BuildFileEnvProperty>>(2*_map47.size);
                String _key48;
                Map<String,BuildFileEnvProperty> _val49;
                for (int _i50 = 0; _i50 < _map47.size; ++_i50)
                {
                  _key48 = iprot.readString();
                  {
                    org.apache.thrift.protocol.TMap _map51 = iprot.readMapBegin();
                    _val49 = new HashMap<String,BuildFileEnvProperty>(2*_map51.size);
                    String _key52;
      ...
      if (struct.allRawNodesJsons != null) {
        if (struct.isSetAllRawNodesJsons()) {
          oprot.writeFieldBegin(ALL_RAW_NODES_JSONS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter55 : struct.allRawNodesJsons.entrySet())
            {
      ...
      if (struct.buildFileDependents != null) {
        if (struct.isSetBuildFileDependents()) {
          oprot.writeFieldBegin(BUILD_FILE_DEPENDENTS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, List<String>> _iter56 : struct.buildFileDependents.entrySet())
            {
      ...
      if (struct.buildFileEnv != null) {
        if (struct.isSetBuildFileEnv()) {
          oprot.writeFieldBegin(BUILD_FILE_ENV_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Map<String,BuildFileEnvProperty>> _iter58 : struct.buildFileEnv.entrySet())
            {
              oprot.writeString(_iter58.getKey());
              {
                ...
                for (Map.Entry<String, BuildFileEnvProperty> _iter59 : _iter58.getValue().entrySet())
                {
      ...
      if (struct.isSetAllRawNodesJsons()) {
        {
          ...
          for (Map.Entry<String, String> _iter60 : struct.allRawNodesJsons.entrySet())
          {
      ...
      if (struct.isSetBuildFileDependents()) {
        {
          ...
          for (Map.Entry<String, List<String>> _iter61 : struct.buildFileDependents.entrySet())
          {
      ...
      if (struct.isSetBuildFileEnv()) {
        {
          ...
          for (Map.Entry<String, Map<String,BuildFileEnvProperty>> _iter63 : struct.buildFileEnv.entrySet())
          {
            oprot.writeString(_iter63.getKey());
            {
              oprot.writeI32(_iter63.getValue().size());
              for (Map.Entry<String, BuildFileEnvProperty> _iter64 : _iter63.getValue().entrySet())
              {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.allRawNodesJsons = new HashMap<String,String>(2*_map65.size);
          String _key66;
          String _val67;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.buildFileDependents = new HashMap<String,List<String>>(2*_map69.size);
          String _key70;
          List<String> _val71;
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.buildFileEnv = new HashMap<String,Map<String,BuildFileEnvProperty>>(2*_map76.size);
          String _key77;
          Map<String,BuildFileEnvProperty> _val78;
          for (int _i79 = 0; _i79 < _map76.size; ++_i79)
          {
            _key77 = iprot.readString();
            {
              ...
              _val78 = new HashMap<String,BuildFileEnvProperty>(2*_map80.size);
              String _key81;
