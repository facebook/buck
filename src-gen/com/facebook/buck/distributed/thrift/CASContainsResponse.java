            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.exists = new java.util.ArrayList<java.lang.Boolean>(_list58.size);
                boolean _elem59;
                for (int _i60 = 0; _i60 < _list58.size; ++_i60)
                {
                  _elem59 = iprot.readBool();
                  struct.exists.add(_elem59);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.exists != null) {
        if (struct.isSetExists()) {
          oprot.writeFieldBegin(EXISTS_FIELD_DESC);
          {
            ...
            for (boolean _iter61 : struct.exists)
            {
      ...
      if (struct.isSetExists()) {
        {
          ...
          for (boolean _iter62 : struct.exists)
          {
            oprot.writeBool(_iter62);
          }
        }
      }
    }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.exists = new java.util.ArrayList<java.lang.Boolean>(_list63.size);
          boolean _elem64;
          for (int _i65 = 0; _i65 < _list63.size; ++_i65)
          {
            _elem64 = iprot.readBool();
            struct.exists.add(_elem64);
          }
        }
        struct.setExistsIsSet(true);
      }
