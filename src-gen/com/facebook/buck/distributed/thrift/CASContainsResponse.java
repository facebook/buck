            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.exists = new ArrayList<Boolean>(_list24.size);
                boolean _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = iprot.readBool();
                  struct.exists.add(_elem25);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.exists != null) {
        if (struct.isSetExists()) {
          oprot.writeFieldBegin(EXISTS_FIELD_DESC);
          {
            ...
            for (boolean _iter27 : struct.exists)
            {
      ...
      if (struct.isSetExists()) {
        {
          ...
          for (boolean _iter28 : struct.exists)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.exists = new ArrayList<Boolean>(_list29.size);
          boolean _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = iprot.readBool();
            struct.exists.add(_elem30);
          }
        }
        struct.setExistsIsSet(true);
      }
