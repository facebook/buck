            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.entries = new ArrayList<BuildJobStateFileHashEntry>(_list52.size);
                BuildJobStateFileHashEntry _elem53;
                for (int _i54 = 0; _i54 < _list52.size; ++_i54)
                {
                  _elem53 = new BuildJobStateFileHashEntry();
                  _elem53.read(iprot);
                  struct.entries.add(_elem53);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.entries != null) {
        if (struct.isSetEntries()) {
          oprot.writeFieldBegin(ENTRIES_FIELD_DESC);
          {
            ...
            for (BuildJobStateFileHashEntry _iter55 : struct.entries)
            {
              _iter55.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetEntries()) {
        {
          ...
          for (BuildJobStateFileHashEntry _iter56 : struct.entries)
          {
            _iter56.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.entries = new ArrayList<BuildJobStateFileHashEntry>(_list57.size);
          BuildJobStateFileHashEntry _elem58;
          for (int _i59 = 0; _i59 < _list57.size; ++_i59)
          {
            _elem58 = new BuildJobStateFileHashEntry();
            _elem58.read(iprot);
            struct.entries.add(_elem58);
          }
        }
        struct.setEntriesIsSet(true);
      }
