            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.entries = new java.util.ArrayList<BuildJobStateFileHashEntry>(_list54.size);
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.entries = new java.util.ArrayList<BuildJobStateFileHashEntry>(_list59.size);
