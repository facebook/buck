            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.events = new java.util.ArrayList<SequencedBuildSlaveEvent>(_list42.size);
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.events = new java.util.ArrayList<SequencedBuildSlaveEvent>(_list47.size);
