            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.files = new ArrayList<FileInfo>(_list58.size);
                FileInfo _elem59;
      ...
      if (struct.files != null) {
        if (struct.isSetFiles()) {
          oprot.writeFieldBegin(FILES_FIELD_DESC);
          {
            ...
            for (FileInfo _iter61 : struct.files)
            {
              _iter61.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetFiles()) {
        {
          ...
          for (FileInfo _iter62 : struct.files)
          {
            _iter62.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.files = new ArrayList<FileInfo>(_list63.size);
          FileInfo _elem64;
          for (int _i65 = 0; _i65 < _list63.size; ++_i65)
          {
            _elem64 = new FileInfo();
            _elem64.read(iprot);
            struct.files.add(_elem64);
          }
        }
        struct.setFilesIsSet(true);
      }
