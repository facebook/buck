            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.files = new ArrayList<FileInfo>(_list32.size);
                FileInfo _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new FileInfo();
                  _elem33.read(iprot);
                  struct.files.add(_elem33);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.files != null) {
        if (struct.isSetFiles()) {
          oprot.writeFieldBegin(FILES_FIELD_DESC);
          {
            ...
            for (FileInfo _iter35 : struct.files)
            {
              _iter35.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetFiles()) {
        {
          ...
          for (FileInfo _iter36 : struct.files)
          {
            _iter36.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.files = new ArrayList<FileInfo>(_list37.size);
          FileInfo _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new FileInfo();
            _elem38.read(iprot);
            struct.files.add(_elem38);
          }
        }
        struct.setFilesIsSet(true);
      }
