            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.files = new java.util.ArrayList<FileInfo>(_list66.size);
                FileInfo _elem67;
                for (int _i68 = 0; _i68 < _list66.size; ++_i68)
                {
                  _elem67 = new FileInfo();
                  _elem67.read(iprot);
                  struct.files.add(_elem67);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.files != null) {
        if (struct.isSetFiles()) {
          oprot.writeFieldBegin(FILES_FIELD_DESC);
          {
            ...
            for (FileInfo _iter69 : struct.files)
            {
              _iter69.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetFiles()) {
        {
          ...
          for (FileInfo _iter70 : struct.files)
          {
            _iter70.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.files = new java.util.ArrayList<FileInfo>(_list71.size);
          FileInfo _elem72;
          for (int _i73 = 0; _i73 < _list71.size; ++_i73)
          {
            _elem72 = new FileInfo();
            _elem72.read(iprot);
            struct.files.add(_elem72);
          }
        }
        struct.setFilesIsSet(true);
      }
