            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.events = new java.util.ArrayList<java.nio.ByteBuffer>(_list138.size);
                java.nio.ByteBuffer _elem139;
      ...
      if (struct.events != null) {
        if (struct.isSetEvents()) {
          oprot.writeFieldBegin(EVENTS_FIELD_DESC);
          {
            ...
            for (java.nio.ByteBuffer _iter141 : struct.events)
            {
      ...
      if (struct.isSetEvents()) {
        {
          ...
          for (java.nio.ByteBuffer _iter142 : struct.events)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.events = new java.util.ArrayList<java.nio.ByteBuffer>(_list143.size);
          java.nio.ByteBuffer _elem144;
