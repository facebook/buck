            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.events = new java.util.ArrayList<java.nio.ByteBuffer>(_list146.size);
                java.nio.ByteBuffer _elem147;
      ...
      if (struct.events != null) {
        if (struct.isSetEvents()) {
          oprot.writeFieldBegin(EVENTS_FIELD_DESC);
          {
            ...
            for (java.nio.ByteBuffer _iter149 : struct.events)
            {
      ...
      if (struct.isSetEvents()) {
        {
          ...
          for (java.nio.ByteBuffer _iter150 : struct.events)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.events = new java.util.ArrayList<java.nio.ByteBuffer>(_list151.size);
          java.nio.ByteBuffer _elem152;
