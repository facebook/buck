            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.responses = new java.util.ArrayList<BuildSlaveEventsRange>(_list162.size);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.responses = new java.util.ArrayList<BuildSlaveEventsRange>(_list167.size);
