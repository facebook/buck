            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.responses = new java.util.ArrayList<BuildSlaveEventsRange>(_list154.size);
                BuildSlaveEventsRange _elem155;
                for (int _i156 = 0; _i156 < _list154.size; ++_i156)
                {
                  _elem155 = new BuildSlaveEventsRange();
                  _elem155.read(iprot);
                  struct.responses.add(_elem155);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.responses != null) {
        if (struct.isSetResponses()) {
          oprot.writeFieldBegin(RESPONSES_FIELD_DESC);
          {
            ...
            for (BuildSlaveEventsRange _iter157 : struct.responses)
            {
      ...
      if (struct.isSetResponses()) {
        {
          ...
          for (BuildSlaveEventsRange _iter158 : struct.responses)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.responses = new java.util.ArrayList<BuildSlaveEventsRange>(_list159.size);
          BuildSlaveEventsRange _elem160;
          for (int _i161 = 0; _i161 < _list159.size; ++_i161)
          {
            _elem160 = new BuildSlaveEventsRange();
            _elem160.read(iprot);
            struct.responses.add(_elem160);
          }
        }
        struct.setResponsesIsSet(true);
      }
