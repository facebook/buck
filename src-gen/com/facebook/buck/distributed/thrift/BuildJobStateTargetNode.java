...
public class BuildJobStateTargetNode implements org.apache.thrift.TBase<BuildJobStateTargetNode, BuildJobStateTargetNode._Fields>, java.io.Serializable, Cloneable, Comparable<BuildJobStateTargetNode> {
  ...
  private static final org.apache.thrift.protocol.TField FILE_SYSTEM_ROOT_INDEX_FIELD_DESC = new org.apache.thrift.protocol.TField("fileSystemRootIndex", org.apache.thrift.protocol.TType.I32, (short)1);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // FILE_SYSTEM_ROOT_INDEX
          return FILE_SYSTEM_ROOT_INDEX;
        case 2: // RAW_NODE
          return RAW_NODE;
        case 3: // BUILD_TARGET
          return BUILD_TARGET;
  ...
  private static final int __FILESYSTEMROOTINDEX_ISSET_ID = 0;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.FILE_SYSTEM_ROOT_INDEX,_Fields.RAW_NODE,_Fields.BUILD_TARGET};
  public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
  static {
    Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
    tmpMap.put(_Fields.FILE_SYSTEM_ROOT_INDEX, new org.apache.thrift.meta_data.FieldMetaData("fileSystemRootIndex", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public BuildJobStateTargetNode(BuildJobStateTargetNode other) {
    ...
    this.fileSystemRootIndex = other.fileSystemRootIndex;
  ...
  @Override
  public void clear() {
    setFileSystemRootIndexIsSet(false);
    this.fileSystemRootIndex = 0;
    this.rawNode = null;
    this.buildTarget = null;
  }

  public int getFileSystemRootIndex() {
    return this.fileSystemRootIndex;
  }

  public BuildJobStateTargetNode setFileSystemRootIndex(int fileSystemRootIndex) {
    this.fileSystemRootIndex = fileSystemRootIndex;
    setFileSystemRootIndexIsSet(true);
    return this;
  }

  public void unsetFileSystemRootIndex() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __FILESYSTEMROOTINDEX_ISSET_ID);
  }

  /** Returns true if field fileSystemRootIndex is set (has been assigned a value) and false otherwise */
  public boolean isSetFileSystemRootIndex() {
    return EncodingUtils.testBit(__isset_bitfield, __FILESYSTEMROOTINDEX_ISSET_ID);
  }

  public void setFileSystemRootIndexIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __FILESYSTEMROOTINDEX_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case FILE_SYSTEM_ROOT_INDEX:
      if (value == null) {
        unsetFileSystemRootIndex();
      } else {
        setFileSystemRootIndex((Integer)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case FILE_SYSTEM_ROOT_INDEX:
      return isSetFileSystemRootIndex();
    case RAW_NODE:
      return isSetRawNode();
    case BUILD_TARGET:
  ...
  public boolean equals(BuildJobStateTargetNode that) {
    ...
    boolean this_present_fileSystemRootIndex = true && this.isSetFileSystemRootIndex();
    boolean that_present_fileSystemRootIndex = true && that.isSetFileSystemRootIndex();
    if (this_present_fileSystemRootIndex || that_present_fileSystemRootIndex) {
      if (!(this_present_fileSystemRootIndex && that_present_fileSystemRootIndex))
        return false;
      if (this.fileSystemRootIndex != that.fileSystemRootIndex)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_fileSystemRootIndex = true && (isSetFileSystemRootIndex());
    list.add(present_fileSystemRootIndex);
    if (present_fileSystemRootIndex)
      list.add(fileSystemRootIndex);
  ...
  public String toString() {
    ...
    if (isSetFileSystemRootIndex()) {
      sb.append("fileSystemRootIndex:");
      sb.append(this.fileSystemRootIndex);
      first = false;
    }
    if (isSetRawNode()) {
      if (!first) sb.append(", ");
  ...
  private static class BuildJobStateTargetNodeStandardScheme extends StandardScheme<BuildJobStateTargetNode> {
        ...
        switch (schemeField.id) {
          case 1: // FILE_SYSTEM_ROOT_INDEX
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.fileSystemRootIndex = iprot.readI32();
              struct.setFileSystemRootIndexIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BuildJobStateTargetNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetFileSystemRootIndex()) {
        oprot.writeFieldBegin(FILE_SYSTEM_ROOT_INDEX_FIELD_DESC);
        oprot.writeI32(struct.fileSystemRootIndex);
        oprot.writeFieldEnd();
      }
