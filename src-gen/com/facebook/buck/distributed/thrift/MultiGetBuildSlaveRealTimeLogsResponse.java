            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.multiStreamLogs = new java.util.ArrayList<StreamLogs>(_list122.size);
                StreamLogs _elem123;
                for (int _i124 = 0; _i124 < _list122.size; ++_i124)
                {
                  _elem123 = new StreamLogs();
                  _elem123.read(iprot);
                  struct.multiStreamLogs.add(_elem123);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.multiStreamLogs != null) {
        if (struct.isSetMultiStreamLogs()) {
          oprot.writeFieldBegin(MULTI_STREAM_LOGS_FIELD_DESC);
          {
            ...
            for (StreamLogs _iter125 : struct.multiStreamLogs)
            {
      ...
      if (struct.isSetMultiStreamLogs()) {
        {
          ...
          for (StreamLogs _iter126 : struct.multiStreamLogs)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.multiStreamLogs = new java.util.ArrayList<StreamLogs>(_list127.size);
          StreamLogs _elem128;
          for (int _i129 = 0; _i129 < _list127.size; ++_i129)
          {
            _elem128 = new StreamLogs();
            _elem128.read(iprot);
            struct.multiStreamLogs.add(_elem128);
          }
        }
        struct.setMultiStreamLogsIsSet(true);
      }
