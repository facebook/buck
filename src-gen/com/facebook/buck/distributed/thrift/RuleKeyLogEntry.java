            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.storeLogEntries = new java.util.ArrayList<RuleKeyStoreLogEntry>(_list170.size);
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.storeLogEntries = new java.util.ArrayList<RuleKeyStoreLogEntry>(_list175.size);
