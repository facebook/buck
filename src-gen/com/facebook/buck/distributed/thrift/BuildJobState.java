...
public class BuildJobState implements org.apache.thrift.TBase<BuildJobState, BuildJobState._Fields>, java.io.Serializable, Cloneable, Comparable<BuildJobState> {
  ...
  private static final _Fields optionals[] = {_Fields.BUCK_CONFIG,_Fields.FILE_HASHES};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fileHashes = new ArrayList<BuildJobStateFileHashes>(_list44.size);
                BuildJobStateFileHashes _elem45;
                for (int _i46 = 0; _i46 < _list44.size; ++_i46)
                {
                  _elem45 = new BuildJobStateFileHashes();
                  _elem45.read(iprot);
                  struct.fileHashes.add(_elem45);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.fileHashes != null) {
        if (struct.isSetFileHashes()) {
          oprot.writeFieldBegin(FILE_HASHES_FIELD_DESC);
          {
            ...
            for (BuildJobStateFileHashes _iter47 : struct.fileHashes)
            {
              _iter47.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetFileHashes()) {
        {
          ...
          for (BuildJobStateFileHashes _iter48 : struct.fileHashes)
          {
            _iter48.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.fileHashes = new ArrayList<BuildJobStateFileHashes>(_list49.size);
          BuildJobStateFileHashes _elem50;
          for (int _i51 = 0; _i51 < _list49.size; ++_i51)
          {
            _elem50 = new BuildJobStateFileHashes();
            _elem50.read(iprot);
            struct.fileHashes.add(_elem50);
          }
        }
        struct.setFileHashesIsSet(true);
      }
