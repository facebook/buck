...
public class BuildJobState implements org.apache.thrift.TBase<BuildJobState, BuildJobState._Fields>, java.io.Serializable, Cloneable, Comparable<BuildJobState> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.cells = new HashMap<Integer,BuildJobStateCell>(2*_map68.size);
                int _key69;
                BuildJobStateCell _val70;
                for (int _i71 = 0; _i71 < _map68.size; ++_i71)
                {
                  _key69 = iprot.readI32();
                  _val70 = new BuildJobStateCell();
                  _val70.read(iprot);
                  struct.cells.put(_key69, _val70);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fileHashes = new ArrayList<BuildJobStateFileHashes>(_list72.size);
                BuildJobStateFileHashes _elem73;
                for (int _i74 = 0; _i74 < _list72.size; ++_i74)
                {
                  _elem73 = new BuildJobStateFileHashes();
                  _elem73.read(iprot);
                  struct.fileHashes.add(_elem73);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.cells != null) {
        if (struct.isSetCells()) {
          oprot.writeFieldBegin(CELLS_FIELD_DESC);
          {
            ...
            for (Map.Entry<Integer, BuildJobStateCell> _iter75 : struct.cells.entrySet())
            {
      ...
      if (struct.fileHashes != null) {
        if (struct.isSetFileHashes()) {
          oprot.writeFieldBegin(FILE_HASHES_FIELD_DESC);
          {
            ...
            for (BuildJobStateFileHashes _iter76 : struct.fileHashes)
            {
              _iter76.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class BuildJobStateTupleScheme extends TupleScheme<BuildJobState> {
      ...
      if (struct.isSetCells()) {
        {
          ...
          for (Map.Entry<Integer, BuildJobStateCell> _iter77 : struct.cells.entrySet())
          {
      ...
      if (struct.isSetFileHashes()) {
        {
          ...
          for (BuildJobStateFileHashes _iter78 : struct.fileHashes)
          {
            _iter78.write(oprot);
          }
        }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, BuildJobState struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map79 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.cells = new HashMap<Integer,BuildJobStateCell>(2*_map79.size);
          int _key80;
          BuildJobStateCell _val81;
          for (int _i82 = 0; _i82 < _map79.size; ++_i82)
          {
            _key80 = iprot.readI32();
            _val81 = new BuildJobStateCell();
            _val81.read(iprot);
            struct.cells.put(_key80, _val81);
          }
        }
        struct.setCellsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.fileHashes = new ArrayList<BuildJobStateFileHashes>(_list83.size);
          BuildJobStateFileHashes _elem84;
          for (int _i85 = 0; _i85 < _list83.size; ++_i85)
          {
            _elem84 = new BuildJobStateFileHashes();
            _elem84.read(iprot);
            struct.fileHashes.add(_elem84);
          }
        }
        struct.setFileHashesIsSet(true);
      }
