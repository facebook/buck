            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.topLevelTargets = new ArrayList<String>(_list67.size);
                String _elem68;
      ...
      if (struct.cells != null) {
        if (struct.isSetCells()) {
          oprot.writeFieldBegin(CELLS_FIELD_DESC);
          {
            ...
            for (Map.Entry<Integer, BuildJobStateCell> _iter70 : struct.cells.entrySet())
            {
      ...
      if (struct.topLevelTargets != null) {
        if (struct.isSetTopLevelTargets()) {
          oprot.writeFieldBegin(TOP_LEVEL_TARGETS_FIELD_DESC);
          {
            ...
            for (String _iter72 : struct.topLevelTargets)
            {
      ...
      if (struct.isSetCells()) {
        {
          ...
          for (Map.Entry<Integer, BuildJobStateCell> _iter73 : struct.cells.entrySet())
          {
      ...
      if (struct.isSetTopLevelTargets()) {
        {
          ...
          for (String _iter75 : struct.topLevelTargets)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.cells = new HashMap<Integer,BuildJobStateCell>(2*_map76.size);
          int _key77;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.fileHashes = new ArrayList<BuildJobStateFileHashes>(_list80.size);
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.topLevelTargets = new ArrayList<String>(_list83.size);
          String _elem84;
