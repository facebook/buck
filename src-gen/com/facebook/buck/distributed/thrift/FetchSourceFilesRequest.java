...
public class FetchSourceFilesRequest implements org.apache.thrift.TBase<FetchSourceFilesRequest, FetchSourceFilesRequest._Fields>, java.io.Serializable, Cloneable, Comparable<FetchSourceFilesRequest> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new FetchSourceFilesRequestStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new FetchSourceFilesRequestTupleSchemeFactory();

  public java.util.List<java.lang.String> contentHashes; // optional
  ...
  public FetchSourceFilesRequest(FetchSourceFilesRequest other) {
    if (other.isSetContentHashes()) {
      java.util.List<java.lang.String> __this__contentHashes = new java.util.ArrayList<java.lang.String>(other.contentHashes);
  ...
  public java.util.Iterator<java.lang.String> getContentHashesIterator() {
    return (this.contentHashes == null) ? null : this.contentHashes.iterator();
  }

  public void addToContentHashes(java.lang.String elem) {
    if (this.contentHashes == null) {
      this.contentHashes = new java.util.ArrayList<java.lang.String>();
    }
    this.contentHashes.add(elem);
  }

  public java.util.List<java.lang.String> getContentHashes() {
    return this.contentHashes;
  }

  public FetchSourceFilesRequest setContentHashes(java.util.List<java.lang.String> contentHashes) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case CONTENT_HASHES:
      if (value == null) {
        ...
        setContentHashes((java.util.List<java.lang.String>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetContentHashes()) ? 131071 : 524287);
    if (isSetContentHashes())
      hashCode = hashCode * 8191 + contentHashes.hashCode();
  ...
  public int compareTo(FetchSourceFilesRequest other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetContentHashes()).compareTo(other.isSetContentHashes());
    if (lastComparison != 0) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("FetchSourceFilesRequest(");
    boolean first = true;
  ...
  private static class FetchSourceFilesRequestStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public FetchSourceFilesRequestStandardScheme getScheme() {
      return new FetchSourceFilesRequestStandardScheme();
    }
  }

  private static class FetchSourceFilesRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<FetchSourceFilesRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.contentHashes = new java.util.ArrayList<java.lang.String>(_list74.size);
                java.lang.String _elem75;
                for (int _i76 = 0; _i76 < _list74.size; ++_i76)
                {
                  _elem75 = iprot.readString();
                  struct.contentHashes.add(_elem75);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.contentHashes != null) {
        if (struct.isSetContentHashes()) {
          oprot.writeFieldBegin(CONTENT_HASHES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter77 : struct.contentHashes)
            {
  ...
  private static class FetchSourceFilesRequestTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public FetchSourceFilesRequestTupleScheme getScheme() {
      return new FetchSourceFilesRequestTupleScheme();
    }
  }

  private static class FetchSourceFilesRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<FetchSourceFilesRequest> {
      ...
      if (struct.isSetContentHashes()) {
        {
          ...
          for (java.lang.String _iter78 : struct.contentHashes)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.contentHashes = new java.util.ArrayList<java.lang.String>(_list79.size);
          java.lang.String _elem80;
          for (int _i81 = 0; _i81 < _list79.size; ++_i81)
          {
            _elem80 = iprot.readString();
            struct.contentHashes.add(_elem80);
          }
        }
        struct.setContentHashesIsSet(true);
      }
