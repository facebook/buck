            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.contentHashes = new ArrayList<String>(_list66.size);
                String _elem67;
                for (int _i68 = 0; _i68 < _list66.size; ++_i68)
                {
                  _elem67 = iprot.readString();
                  struct.contentHashes.add(_elem67);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.contentHashes != null) {
        if (struct.isSetContentHashes()) {
          oprot.writeFieldBegin(CONTENT_HASHES_FIELD_DESC);
          {
            ...
            for (String _iter69 : struct.contentHashes)
            {
      ...
      if (struct.isSetContentHashes()) {
        {
          ...
          for (String _iter70 : struct.contentHashes)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.contentHashes = new ArrayList<String>(_list71.size);
          String _elem72;
          for (int _i73 = 0; _i73 < _list71.size; ++_i73)
          {
            _elem72 = iprot.readString();
            struct.contentHashes.add(_elem72);
          }
        }
        struct.setContentHashesIsSet(true);
      }
