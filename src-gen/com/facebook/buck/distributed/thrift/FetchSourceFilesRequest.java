            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.contentHashes = new ArrayList<String>(_list74.size);
                String _elem75;
      ...
      if (struct.contentHashes != null) {
        if (struct.isSetContentHashes()) {
          oprot.writeFieldBegin(CONTENT_HASHES_FIELD_DESC);
          {
            ...
            for (String _iter77 : struct.contentHashes)
            {
      ...
      if (struct.isSetContentHashes()) {
        {
          ...
          for (String _iter78 : struct.contentHashes)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.contentHashes = new ArrayList<String>(_list79.size);
          String _elem80;
