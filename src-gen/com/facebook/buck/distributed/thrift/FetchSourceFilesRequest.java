            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.contentHashes = new ArrayList<String>(_list40.size);
                String _elem41;
                for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                {
                  _elem41 = iprot.readString();
                  struct.contentHashes.add(_elem41);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.contentHashes != null) {
        if (struct.isSetContentHashes()) {
          oprot.writeFieldBegin(CONTENT_HASHES_FIELD_DESC);
          {
            ...
            for (String _iter43 : struct.contentHashes)
            {
      ...
      if (struct.isSetContentHashes()) {
        {
          ...
          for (String _iter44 : struct.contentHashes)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.contentHashes = new ArrayList<String>(_list45.size);
          String _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = iprot.readString();
            struct.contentHashes.add(_elem46);
          }
        }
        struct.setContentHashesIsSet(true);
      }
