            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.contentHashes = new ArrayList<String>(_list80.size);
                String _elem81;
      ...
      if (struct.contentHashes != null) {
        if (struct.isSetContentHashes()) {
          oprot.writeFieldBegin(CONTENT_HASHES_FIELD_DESC);
          {
            ...
            for (String _iter83 : struct.contentHashes)
            {
      ...
      if (struct.isSetContentHashes()) {
        {
          ...
          for (String _iter84 : struct.contentHashes)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.contentHashes = new ArrayList<String>(_list85.size);
          String _elem86;
