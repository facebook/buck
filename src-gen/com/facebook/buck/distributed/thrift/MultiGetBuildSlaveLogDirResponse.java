            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.logDirs = new java.util.ArrayList<LogDir>(_list106.size);
                LogDir _elem107;
                for (int _i108 = 0; _i108 < _list106.size; ++_i108)
                {
                  _elem107 = new LogDir();
                  _elem107.read(iprot);
                  struct.logDirs.add(_elem107);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.logDirs != null) {
        if (struct.isSetLogDirs()) {
          oprot.writeFieldBegin(LOG_DIRS_FIELD_DESC);
          {
            ...
            for (LogDir _iter109 : struct.logDirs)
            {
      ...
      if (struct.isSetLogDirs()) {
        {
          ...
          for (LogDir _iter110 : struct.logDirs)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.logDirs = new java.util.ArrayList<LogDir>(_list111.size);
          LogDir _elem112;
          for (int _i113 = 0; _i113 < _list111.size; ++_i113)
          {
            _elem112 = new LogDir();
            _elem112.read(iprot);
            struct.logDirs.add(_elem112);
          }
        }
        struct.setLogDirsIsSet(true);
      }
