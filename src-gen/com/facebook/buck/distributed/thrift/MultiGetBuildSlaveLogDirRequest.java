...
public class MultiGetBuildSlaveLogDirRequest implements org.apache.thrift.TBase<MultiGetBuildSlaveLogDirRequest, MultiGetBuildSlaveLogDirRequest._Fields>, java.io.Serializable, Cloneable, Comparable<MultiGetBuildSlaveLogDirRequest> {
  ...
  public List<BuildSlaveRunId> buildSlaveRunIds; // optional
  ...
  public MultiGetBuildSlaveLogDirRequest(MultiGetBuildSlaveLogDirRequest other) {
    ...
    if (other.isSetBuildSlaveRunIds()) {
      List<BuildSlaveRunId> __this__buildSlaveRunIds = new ArrayList<BuildSlaveRunId>(other.buildSlaveRunIds.size());
  ...
  public void addToBuildSlaveRunIds(BuildSlaveRunId elem) {
    if (this.buildSlaveRunIds == null) {
      this.buildSlaveRunIds = new ArrayList<BuildSlaveRunId>();
    }
    this.buildSlaveRunIds.add(elem);
  }

  public List<BuildSlaveRunId> getBuildSlaveRunIds() {
    return this.buildSlaveRunIds;
  }

  public MultiGetBuildSlaveLogDirRequest setBuildSlaveRunIds(List<BuildSlaveRunId> buildSlaveRunIds) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BUILD_SLAVE_RUN_IDS:
      if (value == null) {
        ...
        setBuildSlaveRunIds((List<BuildSlaveRunId>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    boolean present_buildSlaveRunIds = true && (isSetBuildSlaveRunIds());
    list.add(present_buildSlaveRunIds);
    if (present_buildSlaveRunIds)
      list.add(buildSlaveRunIds);
  ...
  public int compareTo(MultiGetBuildSlaveLogDirRequest other) {
    ...
    lastComparison = Boolean.valueOf(isSetBuildSlaveRunIds()).compareTo(other.isSetBuildSlaveRunIds());
    if (lastComparison != 0) {
      return lastComparison;
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.buildSlaveRunIds = new ArrayList<BuildSlaveRunId>(_list106.size);
                BuildSlaveRunId _elem107;
                for (int _i108 = 0; _i108 < _list106.size; ++_i108)
                {
                  _elem107 = new BuildSlaveRunId();
                  _elem107.read(iprot);
                  struct.buildSlaveRunIds.add(_elem107);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.buildSlaveRunIds != null) {
        if (struct.isSetBuildSlaveRunIds()) {
          oprot.writeFieldBegin(BUILD_SLAVE_RUN_IDS_FIELD_DESC);
          {
            ...
            for (BuildSlaveRunId _iter109 : struct.buildSlaveRunIds)
            {
      ...
      if (struct.isSetBuildSlaveRunIds()) {
        {
          ...
          for (BuildSlaveRunId _iter110 : struct.buildSlaveRunIds)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.buildSlaveRunIds = new ArrayList<BuildSlaveRunId>(_list111.size);
          BuildSlaveRunId _elem112;
          for (int _i113 = 0; _i113 < _list111.size; ++_i113)
          {
            _elem112 = new BuildSlaveRunId();
            _elem112.read(iprot);
            struct.buildSlaveRunIds.add(_elem112);
          }
        }
        struct.setBuildSlaveRunIdsIsSet(true);
      }
