            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.buildSlaveRunIds = new ArrayList<BuildSlaveRunId>(_list98.size);
                BuildSlaveRunId _elem99;
                for (int _i100 = 0; _i100 < _list98.size; ++_i100)
                {
                  _elem99 = new BuildSlaveRunId();
                  _elem99.read(iprot);
                  struct.buildSlaveRunIds.add(_elem99);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.buildSlaveRunIds != null) {
        if (struct.isSetBuildSlaveRunIds()) {
          oprot.writeFieldBegin(BUILD_SLAVE_RUN_IDS_FIELD_DESC);
          {
            ...
            for (BuildSlaveRunId _iter101 : struct.buildSlaveRunIds)
            {
      ...
      if (struct.isSetBuildSlaveRunIds()) {
        {
          ...
          for (BuildSlaveRunId _iter102 : struct.buildSlaveRunIds)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.buildSlaveRunIds = new ArrayList<BuildSlaveRunId>(_list103.size);
          BuildSlaveRunId _elem104;
          for (int _i105 = 0; _i105 < _list103.size; ++_i105)
          {
            _elem104 = new BuildSlaveRunId();
            _elem104.read(iprot);
            struct.buildSlaveRunIds.add(_elem104);
          }
        }
        struct.setBuildSlaveRunIdsIsSet(true);
      }
