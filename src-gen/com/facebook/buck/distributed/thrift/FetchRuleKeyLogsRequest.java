            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ruleKeys = new java.util.ArrayList<java.lang.String>(_list170.size);
                java.lang.String _elem171;
      ...
      if (struct.ruleKeys != null) {
        if (struct.isSetRuleKeys()) {
          oprot.writeFieldBegin(RULE_KEYS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter173 : struct.ruleKeys)
            {
      ...
      if (struct.isSetRuleKeys()) {
        {
          ...
          for (java.lang.String _iter174 : struct.ruleKeys)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.ruleKeys = new java.util.ArrayList<java.lang.String>(_list175.size);
          java.lang.String _elem176;
