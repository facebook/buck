            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ruleKeys = new java.util.ArrayList<java.lang.String>(_list178.size);
      ...
      if (struct.ruleKeys != null) {
        if (struct.isSetRuleKeys()) {
          oprot.writeFieldBegin(RULE_KEYS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter181 : struct.ruleKeys)
            {
      ...
      if (struct.isSetRuleKeys()) {
        {
          ...
          for (java.lang.String _iter182 : struct.ruleKeys)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.ruleKeys = new java.util.ArrayList<java.lang.String>(_list183.size);
          java.lang.String _elem184;
