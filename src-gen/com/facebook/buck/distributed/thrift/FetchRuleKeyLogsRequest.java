            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ruleKeys = new ArrayList<String>(_list176.size);
                String _elem177;
      ...
      if (struct.ruleKeys != null) {
        if (struct.isSetRuleKeys()) {
          oprot.writeFieldBegin(RULE_KEYS_FIELD_DESC);
          {
            ...
            for (String _iter179 : struct.ruleKeys)
            {
      ...
      if (struct.isSetRuleKeys()) {
        {
          ...
          for (String _iter180 : struct.ruleKeys)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.ruleKeys = new ArrayList<String>(_list181.size);
          String _elem182;
