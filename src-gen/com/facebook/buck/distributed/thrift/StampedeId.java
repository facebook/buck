...
public class StampedeId implements org.apache.thrift.TBase<StampedeId, StampedeId._Fields>, java.io.Serializable, Cloneable, Comparable<StampedeId> {
  ...
  static {
    schemes.put(StandardScheme.class, new StampedeIdStandardSchemeFactory());
    schemes.put(TupleScheme.class, new StampedeIdTupleSchemeFactory());
  }
  ...
  public StampedeId setId(String id) {
    this.id = id;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("StampedeId(");
    boolean first = true;
  ...
  private static class StampedeIdStandardSchemeFactory implements SchemeFactory {
    public StampedeIdStandardScheme getScheme() {
      return new StampedeIdStandardScheme();
    }
  }

  private static class StampedeIdStandardScheme extends StandardScheme<StampedeId> {
  ...
  private static class StampedeIdTupleSchemeFactory implements SchemeFactory {
    public StampedeIdTupleScheme getScheme() {
      return new StampedeIdTupleScheme();
    }
  }

  private static class StampedeIdTupleScheme extends TupleScheme<StampedeId> {
