...
public class BuildSlaveStatus implements org.apache.thrift.TBase<BuildSlaveStatus, BuildSlaveStatus._Fields>, java.io.Serializable, Cloneable, Comparable<BuildSlaveStatus> {
  ...
  public void unsetFilesMaterializedCount() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __FILESMATERIALIZEDCOUNT_ISSET_ID);
  }
  ...
  public boolean isSetFilesMaterializedCount() {
    return EncodingUtils.testBit(__isset_bitfield, __FILESMATERIALIZEDCOUNT_ISSET_ID);
  }

  public void setFilesMaterializedCountIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __FILESMATERIALIZEDCOUNT_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case FILES_MATERIALIZED_COUNT:
      if (value == null) {
        ...
        setFilesMaterializedCount((Integer)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    boolean present_filesMaterializedCount = true && (isSetFilesMaterializedCount());
    list.add(present_filesMaterializedCount);
    if (present_filesMaterializedCount)
      list.add(filesMaterializedCount);
  ...
  public int compareTo(BuildSlaveStatus other) {
    ...
    lastComparison = Boolean.valueOf(isSetFilesMaterializedCount()).compareTo(other.isSetFilesMaterializedCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
