...
public class BuildSlaveStatus implements org.apache.thrift.TBase<BuildSlaveStatus, BuildSlaveStatus._Fields>, java.io.Serializable, Cloneable, Comparable<BuildSlaveStatus> {
  ...
  private static final org.apache.thrift.protocol.TField HTTP_ARTIFACT_UPLOAD_SCHEDULED_COUNT_FIELD_DESC = new org.apache.thrift.protocol.TField("httpArtifactUploadScheduledCount", org.apache.thrift.protocol.TType.I32, (short)22);
  private static final org.apache.thrift.protocol.TField HTTP_ARTIFACT_UPLOAD_STARTED_COUNT_FIELD_DESC = new org.apache.thrift.protocol.TField("httpArtifactUploadStartedCount", org.apache.thrift.protocol.TType.I32, (short)23);
  private static final org.apache.thrift.protocol.TField HTTP_ARTIFACT_UPLOAD_SUCCESS_COUNT_FIELD_DESC = new org.apache.thrift.protocol.TField("httpArtifactUploadSuccessCount", org.apache.thrift.protocol.TType.I32, (short)24);
  private static final org.apache.thrift.protocol.TField HTTP_ARTIFACT_UPLOAD_FAILURE_COUNT_FIELD_DESC = new org.apache.thrift.protocol.TField("httpArtifactUploadFailureCount", org.apache.thrift.protocol.TType.I32, (short)25);
  ...
  public int httpArtifactUploadScheduledCount; // optional
  public int httpArtifactUploadStartedCount; // optional
  public int httpArtifactUploadSuccessCount; // optional
  public int httpArtifactUploadFailureCount; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    HTTP_ARTIFACT_UPLOAD_SCHEDULED_COUNT((short)22, "httpArtifactUploadScheduledCount"),
    HTTP_ARTIFACT_UPLOAD_STARTED_COUNT((short)23, "httpArtifactUploadStartedCount"),
    HTTP_ARTIFACT_UPLOAD_SUCCESS_COUNT((short)24, "httpArtifactUploadSuccessCount"),
    HTTP_ARTIFACT_UPLOAD_FAILURE_COUNT((short)25, "httpArtifactUploadFailureCount");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 22: // HTTP_ARTIFACT_UPLOAD_SCHEDULED_COUNT
          return HTTP_ARTIFACT_UPLOAD_SCHEDULED_COUNT;
        case 23: // HTTP_ARTIFACT_UPLOAD_STARTED_COUNT
          return HTTP_ARTIFACT_UPLOAD_STARTED_COUNT;
        case 24: // HTTP_ARTIFACT_UPLOAD_SUCCESS_COUNT
          return HTTP_ARTIFACT_UPLOAD_SUCCESS_COUNT;
        case 25: // HTTP_ARTIFACT_UPLOAD_FAILURE_COUNT
          return HTTP_ARTIFACT_UPLOAD_FAILURE_COUNT;
        default:
          return null;
      }
    }
  ...
  static {
    ...
    tmpMap.put(_Fields.HTTP_ARTIFACT_UPLOAD_SCHEDULED_COUNT, new org.apache.thrift.meta_data.FieldMetaData("httpArtifactUploadScheduledCount", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.HTTP_ARTIFACT_UPLOAD_STARTED_COUNT, new org.apache.thrift.meta_data.FieldMetaData("httpArtifactUploadStartedCount", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.HTTP_ARTIFACT_UPLOAD_SUCCESS_COUNT, new org.apache.thrift.meta_data.FieldMetaData("httpArtifactUploadSuccessCount", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.HTTP_ARTIFACT_UPLOAD_FAILURE_COUNT, new org.apache.thrift.meta_data.FieldMetaData("httpArtifactUploadFailureCount", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public BuildSlaveStatus(BuildSlaveStatus other) {
    ...
    this.httpArtifactUploadScheduledCount = other.httpArtifactUploadScheduledCount;
    this.httpArtifactUploadStartedCount = other.httpArtifactUploadStartedCount;
    this.httpArtifactUploadSuccessCount = other.httpArtifactUploadSuccessCount;
    this.httpArtifactUploadFailureCount = other.httpArtifactUploadFailureCount;
  }
  ...
  public void clear() {
    ...
    setHttpArtifactUploadScheduledCountIsSet(false);
    this.httpArtifactUploadScheduledCount = 0;
    setHttpArtifactUploadStartedCountIsSet(false);
    this.httpArtifactUploadStartedCount = 0;
    setHttpArtifactUploadSuccessCountIsSet(false);
    this.httpArtifactUploadSuccessCount = 0;
    setHttpArtifactUploadFailureCountIsSet(false);
    this.httpArtifactUploadFailureCount = 0;
  }
  ...
  public int getHttpArtifactUploadScheduledCount() {
    return this.httpArtifactUploadScheduledCount;
  }

  public BuildSlaveStatus setHttpArtifactUploadScheduledCount(int httpArtifactUploadScheduledCount) {
    this.httpArtifactUploadScheduledCount = httpArtifactUploadScheduledCount;
    setHttpArtifactUploadScheduledCountIsSet(true);
    return this;
  }

  public void unsetHttpArtifactUploadScheduledCount() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __HTTPARTIFACTUPLOADSCHEDULEDCOUNT_ISSET_ID);
  }

  /** Returns true if field httpArtifactUploadScheduledCount is set (has been assigned a value) and false otherwise */
  public boolean isSetHttpArtifactUploadScheduledCount() {
    return EncodingUtils.testBit(__isset_bitfield, __HTTPARTIFACTUPLOADSCHEDULEDCOUNT_ISSET_ID);
  }

  public void setHttpArtifactUploadScheduledCountIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __HTTPARTIFACTUPLOADSCHEDULEDCOUNT_ISSET_ID, value);
  }

  public int getHttpArtifactUploadStartedCount() {
    return this.httpArtifactUploadStartedCount;
  }

  public BuildSlaveStatus setHttpArtifactUploadStartedCount(int httpArtifactUploadStartedCount) {
    this.httpArtifactUploadStartedCount = httpArtifactUploadStartedCount;
    setHttpArtifactUploadStartedCountIsSet(true);
    return this;
  }

  public void unsetHttpArtifactUploadStartedCount() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __HTTPARTIFACTUPLOADSTARTEDCOUNT_ISSET_ID);
  }

  /** Returns true if field httpArtifactUploadStartedCount is set (has been assigned a value) and false otherwise */
  public boolean isSetHttpArtifactUploadStartedCount() {
    return EncodingUtils.testBit(__isset_bitfield, __HTTPARTIFACTUPLOADSTARTEDCOUNT_ISSET_ID);
  }

  public void setHttpArtifactUploadStartedCountIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __HTTPARTIFACTUPLOADSTARTEDCOUNT_ISSET_ID, value);
  }

  public int getHttpArtifactUploadSuccessCount() {
    return this.httpArtifactUploadSuccessCount;
  }

  public BuildSlaveStatus setHttpArtifactUploadSuccessCount(int httpArtifactUploadSuccessCount) {
    this.httpArtifactUploadSuccessCount = httpArtifactUploadSuccessCount;
    setHttpArtifactUploadSuccessCountIsSet(true);
    return this;
  }

  public void unsetHttpArtifactUploadSuccessCount() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __HTTPARTIFACTUPLOADSUCCESSCOUNT_ISSET_ID);
  }

  /** Returns true if field httpArtifactUploadSuccessCount is set (has been assigned a value) and false otherwise */
  public boolean isSetHttpArtifactUploadSuccessCount() {
    return EncodingUtils.testBit(__isset_bitfield, __HTTPARTIFACTUPLOADSUCCESSCOUNT_ISSET_ID);
  }

  public void setHttpArtifactUploadSuccessCountIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __HTTPARTIFACTUPLOADSUCCESSCOUNT_ISSET_ID, value);
  }

  public int getHttpArtifactUploadFailureCount() {
    return this.httpArtifactUploadFailureCount;
  }

  public BuildSlaveStatus setHttpArtifactUploadFailureCount(int httpArtifactUploadFailureCount) {
    this.httpArtifactUploadFailureCount = httpArtifactUploadFailureCount;
    setHttpArtifactUploadFailureCountIsSet(true);
    return this;
  }

  public void unsetHttpArtifactUploadFailureCount() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __HTTPARTIFACTUPLOADFAILURECOUNT_ISSET_ID);
  }

  /** Returns true if field httpArtifactUploadFailureCount is set (has been assigned a value) and false otherwise */
  public boolean isSetHttpArtifactUploadFailureCount() {
    return EncodingUtils.testBit(__isset_bitfield, __HTTPARTIFACTUPLOADFAILURECOUNT_ISSET_ID);
  }

  public void setHttpArtifactUploadFailureCountIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __HTTPARTIFACTUPLOADFAILURECOUNT_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case HTTP_ARTIFACT_UPLOAD_SCHEDULED_COUNT:
      if (value == null) {
        unsetHttpArtifactUploadScheduledCount();
      } else {
        setHttpArtifactUploadScheduledCount((Integer)value);
      }
      break;

    case HTTP_ARTIFACT_UPLOAD_STARTED_COUNT:
      if (value == null) {
        unsetHttpArtifactUploadStartedCount();
      } else {
        setHttpArtifactUploadStartedCount((Integer)value);
      }
      break;

    case HTTP_ARTIFACT_UPLOAD_SUCCESS_COUNT:
      if (value == null) {
        unsetHttpArtifactUploadSuccessCount();
      } else {
        setHttpArtifactUploadSuccessCount((Integer)value);
      }
      break;

    case HTTP_ARTIFACT_UPLOAD_FAILURE_COUNT:
      if (value == null) {
        unsetHttpArtifactUploadFailureCount();
      } else {
        setHttpArtifactUploadFailureCount((Integer)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case HTTP_ARTIFACT_UPLOAD_STARTED_COUNT:
      return getHttpArtifactUploadStartedCount();

    case HTTP_ARTIFACT_UPLOAD_SUCCESS_COUNT:
      return getHttpArtifactUploadSuccessCount();

    case HTTP_ARTIFACT_UPLOAD_FAILURE_COUNT:
      return getHttpArtifactUploadFailureCount();
  ...
  public boolean isSet(_Fields field) {
    ...
    case HTTP_ARTIFACT_UPLOAD_SCHEDULED_COUNT:
      return isSetHttpArtifactUploadScheduledCount();
    case HTTP_ARTIFACT_UPLOAD_STARTED_COUNT:
      return isSetHttpArtifactUploadStartedCount();
    case HTTP_ARTIFACT_UPLOAD_SUCCESS_COUNT:
      return isSetHttpArtifactUploadSuccessCount();
    case HTTP_ARTIFACT_UPLOAD_FAILURE_COUNT:
      return isSetHttpArtifactUploadFailureCount();
    }
    throw new IllegalStateException();
  }
  ...
  public boolean equals(BuildSlaveStatus that) {
    ...
    boolean this_present_httpArtifactUploadScheduledCount = true && this.isSetHttpArtifactUploadScheduledCount();
    boolean that_present_httpArtifactUploadScheduledCount = true && that.isSetHttpArtifactUploadScheduledCount();
    if (this_present_httpArtifactUploadScheduledCount || that_present_httpArtifactUploadScheduledCount) {
      if (!(this_present_httpArtifactUploadScheduledCount && that_present_httpArtifactUploadScheduledCount))
        return false;
      if (this.httpArtifactUploadScheduledCount != that.httpArtifactUploadScheduledCount)
        return false;
    }

    boolean this_present_httpArtifactUploadStartedCount = true && this.isSetHttpArtifactUploadStartedCount();
    ...
    if (this_present_httpArtifactUploadStartedCount || that_present_httpArtifactUploadStartedCount) {
      if (!(this_present_httpArtifactUploadStartedCount && that_present_httpArtifactUploadStartedCount))
        return false;
      if (this.httpArtifactUploadStartedCount != that.httpArtifactUploadStartedCount)
        return false;
    }

    boolean this_present_httpArtifactUploadSuccessCount = true && this.isSetHttpArtifactUploadSuccessCount();
    boolean that_present_httpArtifactUploadSuccessCount = true && that.isSetHttpArtifactUploadSuccessCount();
    if (this_present_httpArtifactUploadSuccessCount || that_present_httpArtifactUploadSuccessCount) {
      if (!(this_present_httpArtifactUploadSuccessCount && that_present_httpArtifactUploadSuccessCount))
        return false;
      if (this.httpArtifactUploadSuccessCount != that.httpArtifactUploadSuccessCount)
        return false;
    }

    boolean this_present_httpArtifactUploadFailureCount = true && this.isSetHttpArtifactUploadFailureCount();
    boolean that_present_httpArtifactUploadFailureCount = true && that.isSetHttpArtifactUploadFailureCount();
    if (this_present_httpArtifactUploadFailureCount || that_present_httpArtifactUploadFailureCount) {
      if (!(this_present_httpArtifactUploadFailureCount && that_present_httpArtifactUploadFailureCount))
        return false;
      if (this.httpArtifactUploadFailureCount != that.httpArtifactUploadFailureCount)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_httpArtifactUploadScheduledCount = true && (isSetHttpArtifactUploadScheduledCount());
    list.add(present_httpArtifactUploadScheduledCount);
    if (present_httpArtifactUploadScheduledCount)
      list.add(httpArtifactUploadScheduledCount);

    boolean present_httpArtifactUploadStartedCount = true && (isSetHttpArtifactUploadStartedCount());
    list.add(present_httpArtifactUploadStartedCount);
    if (present_httpArtifactUploadStartedCount)
      list.add(httpArtifactUploadStartedCount);

    boolean present_httpArtifactUploadSuccessCount = true && (isSetHttpArtifactUploadSuccessCount());
    list.add(present_httpArtifactUploadSuccessCount);
    if (present_httpArtifactUploadSuccessCount)
      list.add(httpArtifactUploadSuccessCount);

    boolean present_httpArtifactUploadFailureCount = true && (isSetHttpArtifactUploadFailureCount());
    list.add(present_httpArtifactUploadFailureCount);
    if (present_httpArtifactUploadFailureCount)
      list.add(httpArtifactUploadFailureCount);
  ...
  public int compareTo(BuildSlaveStatus other) {
    ...
    lastComparison = Boolean.valueOf(isSetHttpArtifactUploadScheduledCount()).compareTo(other.isSetHttpArtifactUploadScheduledCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHttpArtifactUploadScheduledCount()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.httpArtifactUploadScheduledCount, other.httpArtifactUploadScheduledCount);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetHttpArtifactUploadStartedCount()).compareTo(other.isSetHttpArtifactUploadStartedCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHttpArtifactUploadStartedCount()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.httpArtifactUploadStartedCount, other.httpArtifactUploadStartedCount);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetHttpArtifactUploadSuccessCount()).compareTo(other.isSetHttpArtifactUploadSuccessCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHttpArtifactUploadSuccessCount()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.httpArtifactUploadSuccessCount, other.httpArtifactUploadSuccessCount);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetHttpArtifactUploadFailureCount()).compareTo(other.isSetHttpArtifactUploadFailureCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHttpArtifactUploadFailureCount()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.httpArtifactUploadFailureCount, other.httpArtifactUploadFailureCount);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetHttpArtifactUploadScheduledCount()) {
      if (!first) sb.append(", ");
      sb.append("httpArtifactUploadScheduledCount:");
      sb.append(this.httpArtifactUploadScheduledCount);
      first = false;
    }
    if (isSetHttpArtifactUploadStartedCount()) {
      if (!first) sb.append(", ");
      sb.append("httpArtifactUploadStartedCount:");
      sb.append(this.httpArtifactUploadStartedCount);
      first = false;
    }
    if (isSetHttpArtifactUploadSuccessCount()) {
      if (!first) sb.append(", ");
      sb.append("httpArtifactUploadSuccessCount:");
      sb.append(this.httpArtifactUploadSuccessCount);
      first = false;
    }
    if (isSetHttpArtifactUploadFailureCount()) {
      if (!first) sb.append(", ");
      sb.append("httpArtifactUploadFailureCount:");
      sb.append(this.httpArtifactUploadFailureCount);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class BuildSlaveStatusStandardScheme extends StandardScheme<BuildSlaveStatus> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, BuildSlaveStatus struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 22: // HTTP_ARTIFACT_UPLOAD_SCHEDULED_COUNT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.httpArtifactUploadScheduledCount = iprot.readI32();
              struct.setHttpArtifactUploadScheduledCountIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 23: // HTTP_ARTIFACT_UPLOAD_STARTED_COUNT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.httpArtifactUploadStartedCount = iprot.readI32();
              struct.setHttpArtifactUploadStartedCountIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 24: // HTTP_ARTIFACT_UPLOAD_SUCCESS_COUNT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.httpArtifactUploadSuccessCount = iprot.readI32();
              struct.setHttpArtifactUploadSuccessCountIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 25: // HTTP_ARTIFACT_UPLOAD_FAILURE_COUNT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.httpArtifactUploadFailureCount = iprot.readI32();
              struct.setHttpArtifactUploadFailureCountIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BuildSlaveStatus struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetHttpArtifactUploadScheduledCount()) {
        oprot.writeFieldBegin(HTTP_ARTIFACT_UPLOAD_SCHEDULED_COUNT_FIELD_DESC);
        oprot.writeI32(struct.httpArtifactUploadScheduledCount);
        oprot.writeFieldEnd();
      }
      if (struct.isSetHttpArtifactUploadStartedCount()) {
        oprot.writeFieldBegin(HTTP_ARTIFACT_UPLOAD_STARTED_COUNT_FIELD_DESC);
        oprot.writeI32(struct.httpArtifactUploadStartedCount);
        oprot.writeFieldEnd();
      }
      if (struct.isSetHttpArtifactUploadSuccessCount()) {
        oprot.writeFieldBegin(HTTP_ARTIFACT_UPLOAD_SUCCESS_COUNT_FIELD_DESC);
        oprot.writeI32(struct.httpArtifactUploadSuccessCount);
        oprot.writeFieldEnd();
      }
      if (struct.isSetHttpArtifactUploadFailureCount()) {
        oprot.writeFieldBegin(HTTP_ARTIFACT_UPLOAD_FAILURE_COUNT_FIELD_DESC);
        oprot.writeI32(struct.httpArtifactUploadFailureCount);
        oprot.writeFieldEnd();
      }
