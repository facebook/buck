...
public class FrontendResponse implements org.apache.thrift.TBase<FrontendResponse, FrontendResponse._Fields>, java.io.Serializable, Cloneable, Comparable<FrontendResponse> {
  ...
  public int hashCode() {
    ...
    boolean present_fetchRuleKeyLogsResponse = true && (isSetFetchRuleKeyLogsResponse());
    list.add(present_fetchRuleKeyLogsResponse);
    if (present_fetchRuleKeyLogsResponse)
      list.add(fetchRuleKeyLogsResponse);

    boolean present_storeBuildSlaveFinishedStatsResponse = true && (isSetStoreBuildSlaveFinishedStatsResponse());
    list.add(present_storeBuildSlaveFinishedStatsResponse);
    if (present_storeBuildSlaveFinishedStatsResponse)
      list.add(storeBuildSlaveFinishedStatsResponse);

    boolean present_fetchBuildSlaveFinishedStatsResponse = true && (isSetFetchBuildSlaveFinishedStatsResponse());
    list.add(present_fetchBuildSlaveFinishedStatsResponse);
    if (present_fetchBuildSlaveFinishedStatsResponse)
      list.add(fetchBuildSlaveFinishedStatsResponse);

    boolean present_setCoordinatorResponse = true && (isSetSetCoordinatorResponse());
    list.add(present_setCoordinatorResponse);
    if (present_setCoordinatorResponse)
      list.add(setCoordinatorResponse);

    boolean present_enqueueMinionsResponse = true && (isSetEnqueueMinionsResponse());
    list.add(present_enqueueMinionsResponse);
    if (present_enqueueMinionsResponse)
      list.add(enqueueMinionsResponse);

    boolean present_setFinalBuildStatusResponse = true && (isSetSetFinalBuildStatusResponse());
    list.add(present_setFinalBuildStatusResponse);
    if (present_setFinalBuildStatusResponse)
      list.add(setFinalBuildStatusResponse);

    boolean present_reportCoordinatorAliveResponse = true && (isSetReportCoordinatorAliveResponse());
    list.add(present_reportCoordinatorAliveResponse);
    if (present_reportCoordinatorAliveResponse)
      list.add(reportCoordinatorAliveResponse);
  ...
  public int compareTo(FrontendResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetFetchRuleKeyLogsResponse()).compareTo(other.isSetFetchRuleKeyLogsResponse());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetStoreBuildSlaveFinishedStatsResponse()).compareTo(other.isSetStoreBuildSlaveFinishedStatsResponse());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetFetchBuildSlaveFinishedStatsResponse()).compareTo(other.isSetFetchBuildSlaveFinishedStatsResponse());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetSetCoordinatorResponse()).compareTo(other.isSetSetCoordinatorResponse());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetEnqueueMinionsResponse()).compareTo(other.isSetEnqueueMinionsResponse());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetSetFinalBuildStatusResponse()).compareTo(other.isSetSetFinalBuildStatusResponse());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetReportCoordinatorAliveResponse()).compareTo(other.isSetReportCoordinatorAliveResponse());
    if (lastComparison != 0) {
      return lastComparison;
    }
