            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.nodes = new ArrayList<BuildJobStateTargetNode>(_list60.size);
                BuildJobStateTargetNode _elem61;
                for (int _i62 = 0; _i62 < _list60.size; ++_i62)
                {
                  _elem61 = new BuildJobStateTargetNode();
                  _elem61.read(iprot);
                  struct.nodes.add(_elem61);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.nodes != null) {
        if (struct.isSetNodes()) {
          oprot.writeFieldBegin(NODES_FIELD_DESC);
          {
            ...
            for (BuildJobStateTargetNode _iter63 : struct.nodes)
            {
              _iter63.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetNodes()) {
        {
          ...
          for (BuildJobStateTargetNode _iter64 : struct.nodes)
          {
            _iter64.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.nodes = new ArrayList<BuildJobStateTargetNode>(_list65.size);
          BuildJobStateTargetNode _elem66;
          for (int _i67 = 0; _i67 < _list65.size; ++_i67)
          {
            _elem66 = new BuildJobStateTargetNode();
            _elem66.read(iprot);
            struct.nodes.add(_elem66);
          }
        }
        struct.setNodesIsSet(true);
      }
