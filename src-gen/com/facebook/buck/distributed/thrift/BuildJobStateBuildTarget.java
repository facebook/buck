...
public class BuildJobStateBuildTarget implements org.apache.thrift.TBase<BuildJobStateBuildTarget, BuildJobStateBuildTarget._Fields>, java.io.Serializable, Cloneable, Comparable<BuildJobStateBuildTarget> {
  ...
  private static final org.apache.thrift.protocol.TField CELL_PATH_FIELD_DESC = new org.apache.thrift.protocol.TField("cellPath", org.apache.thrift.protocol.TType.STRING, (short)1);
  private static final org.apache.thrift.protocol.TField CELL_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("cellName", org.apache.thrift.protocol.TType.STRING, (short)2);
  private static final org.apache.thrift.protocol.TField BASE_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("baseName", org.apache.thrift.protocol.TType.STRING, (short)3);
  ...
  private static final org.apache.thrift.protocol.TField FLAVORS_FIELD_DESC = new org.apache.thrift.protocol.TField("flavors", org.apache.thrift.protocol.TType.SET, (short)5);
  ...
  public String cellPath; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    CELL_PATH((short)1, "cellPath"),
    CELL_NAME((short)2, "cellName"),
    BASE_NAME((short)3, "baseName"),
    SHORT_NAME((short)4, "shortName"),
    FLAVORS((short)5, "flavors");
  ...
  static {
    ...
    tmpMap.put(_Fields.CELL_PATH, new org.apache.thrift.meta_data.FieldMetaData("cellPath", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public BuildJobStateBuildTarget(BuildJobStateBuildTarget other) {
    if (other.isSetCellPath()) {
      this.cellPath = other.cellPath;
    }
  ...
  public BuildJobStateBuildTarget setCellPath(String cellPath) {
    this.cellPath = cellPath;
    return this;
  }

  public void unsetCellPath() {
    this.cellPath = null;
  }

  /** Returns true if field cellPath is set (has been assigned a value) and false otherwise */
  public boolean isSetCellPath() {
    return this.cellPath != null;
  }

  public void setCellPathIsSet(boolean value) {
    if (!value) {
      this.cellPath = null;
    }
  }
  ...
  public boolean equals(BuildJobStateBuildTarget that) {
    ...
    boolean this_present_cellPath = true && this.isSetCellPath();
    boolean that_present_cellPath = true && that.isSetCellPath();
    if (this_present_cellPath || that_present_cellPath) {
      if (!(this_present_cellPath && that_present_cellPath))
        return false;
      if (!this.cellPath.equals(that.cellPath))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_cellPath = true && (isSetCellPath());
    list.add(present_cellPath);
    if (present_cellPath)
      list.add(cellPath);
  ...
  public int compareTo(BuildJobStateBuildTarget other) {
    ...
    lastComparison = Boolean.valueOf(isSetCellPath()).compareTo(other.isSetCellPath());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCellPath()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cellPath, other.cellPath);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class BuildJobStateBuildTargetStandardScheme extends StandardScheme<BuildJobStateBuildTarget> {
        ...
        switch (schemeField.id) {
          case 1: // CELL_PATH
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.cellPath = iprot.readString();
              struct.setCellPathIsSet(true);
            } else { 
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.flavors = new HashSet<String>(2*_set36.size);
                String _elem37;
                for (int _i38 = 0; _i38 < _set36.size; ++_i38)
                {
                  _elem37 = iprot.readString();
                  struct.flavors.add(_elem37);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BuildJobStateBuildTarget struct) throws org.apache.thrift.TException {
      ...
      if (struct.cellPath != null) {
        oprot.writeFieldBegin(CELL_PATH_FIELD_DESC);
        oprot.writeString(struct.cellPath);
        oprot.writeFieldEnd();
      }
      ...
      if (struct.flavors != null) {
        oprot.writeFieldBegin(FLAVORS_FIELD_DESC);
        {
          ...
          for (String _iter39 : struct.flavors)
          {
      ...
      if (struct.isSetFlavors()) {
        {
          ...
          for (String _iter40 : struct.flavors)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.flavors = new HashSet<String>(2*_set41.size);
          String _elem42;
          for (int _i43 = 0; _i43 < _set41.size; ++_i43)
          {
            _elem42 = iprot.readString();
            struct.flavors.add(_elem42);
          }
        }
        struct.setFlavorsIsSet(true);
      }
