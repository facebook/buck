...
public class BuildJob implements org.apache.thrift.TBase<BuildJob, BuildJob._Fields>, java.io.Serializable, Cloneable, Comparable<BuildJob> {
  ...
  public java.util.Map<java.lang.String,BuildSlaveInfo> slaveInfoByRunId; // optional
  ...
  private static final _Fields optionals[] = {_Fields.STAMPEDE_ID,_Fields.STATUS,_Fields.BUCK_VERSION,_Fields.SLAVE_INFO_BY_RUN_ID,_Fields.DOT_FILES,_Fields.BUILD_MODE_INFO,_Fields.REPOSITORY,_Fields.TENANT_ID,_Fields.STATUS_MESSAGE,_Fields.BUCK_BUILD_UUID};
  ...
  public BuildJob(BuildJob other) {
    ...
    if (other.isSetSlaveInfoByRunId()) {
      java.util.Map<java.lang.String,BuildSlaveInfo> __this__slaveInfoByRunId = new java.util.HashMap<java.lang.String,BuildSlaveInfo>(other.slaveInfoByRunId.size());
      for (java.util.Map.Entry<java.lang.String, BuildSlaveInfo> other_element : other.slaveInfoByRunId.entrySet()) {

        java.lang.String other_element_key = other_element.getKey();
        BuildSlaveInfo other_element_value = other_element.getValue();

        java.lang.String __this__slaveInfoByRunId_copy_key = other_element_key;
  ...
  public void putToSlaveInfoByRunId(java.lang.String key, BuildSlaveInfo val) {
    if (this.slaveInfoByRunId == null) {
      this.slaveInfoByRunId = new java.util.HashMap<java.lang.String,BuildSlaveInfo>();
    }
    this.slaveInfoByRunId.put(key, val);
  }

  public java.util.Map<java.lang.String,BuildSlaveInfo> getSlaveInfoByRunId() {
    return this.slaveInfoByRunId;
  }

  public BuildJob setSlaveInfoByRunId(java.util.Map<java.lang.String,BuildSlaveInfo> slaveInfoByRunId) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case SLAVE_INFO_BY_RUN_ID:
      if (value == null) {
        ...
        setSlaveInfoByRunId((java.util.Map<java.lang.String,BuildSlaveInfo>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetSlaveInfoByRunId()) ? 131071 : 524287);
    if (isSetSlaveInfoByRunId())
      hashCode = hashCode * 8191 + slaveInfoByRunId.hashCode();
  ...
  public int compareTo(BuildJob other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSlaveInfoByRunId()).compareTo(other.isSetSlaveInfoByRunId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSlaveInfoByRunId()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.slaveInfoByRunId = new java.util.HashMap<java.lang.String,BuildSlaveInfo>(2*_map24.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.dotFiles = new java.util.ArrayList<PathInfo>(_list28.size);
                PathInfo _elem29;
      ...
      if (struct.slaveInfoByRunId != null) {
        if (struct.isSetSlaveInfoByRunId()) {
          oprot.writeFieldBegin(SLAVE_INFO_BY_RUN_ID_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, BuildSlaveInfo> _iter31 : struct.slaveInfoByRunId.entrySet())
            {
      ...
      if (struct.isSetSlaveInfoByRunId()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, BuildSlaveInfo> _iter33 : struct.slaveInfoByRunId.entrySet())
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.slaveInfoByRunId = new java.util.HashMap<java.lang.String,BuildSlaveInfo>(2*_map35.size);
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.dotFiles = new java.util.ArrayList<PathInfo>(_list39.size);
          PathInfo _elem40;
