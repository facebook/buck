...
public class BuildJob implements org.apache.thrift.TBase<BuildJob, BuildJob._Fields>, java.io.Serializable, Cloneable, Comparable<BuildJob> {
  ...
  private static final _Fields optionals[] = {_Fields.STAMPEDE_ID,_Fields.DEBUG,_Fields.STATUS,_Fields.BUCK_VERSION,_Fields.SLAVE_INFO_BY_RUN_ID,_Fields.DOT_FILES,_Fields.BUILD_MODE_INFO,_Fields.REPOSITORY,_Fields.TENANT_ID};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.slaveInfoByRunId = new java.util.HashMap<java.lang.String,BuildSlaveInfo>(2*_map32.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.dotFiles = new java.util.ArrayList<PathInfo>(_list36.size);
                PathInfo _elem37;
      ...
      if (struct.slaveInfoByRunId != null) {
        if (struct.isSetSlaveInfoByRunId()) {
          oprot.writeFieldBegin(SLAVE_INFO_BY_RUN_ID_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, BuildSlaveInfo> _iter39 : struct.slaveInfoByRunId.entrySet())
            {
      ...
      if (struct.isSetSlaveInfoByRunId()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, BuildSlaveInfo> _iter41 : struct.slaveInfoByRunId.entrySet())
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.slaveInfoByRunId = new java.util.HashMap<java.lang.String,BuildSlaveInfo>(2*_map43.size);
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.dotFiles = new java.util.ArrayList<PathInfo>(_list47.size);
          PathInfo _elem48;
