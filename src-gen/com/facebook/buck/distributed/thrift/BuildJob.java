...
public class BuildJob implements org.apache.thrift.TBase<BuildJob, BuildJob._Fields>, java.io.Serializable, Cloneable, Comparable<BuildJob> {
  ...
  private static final _Fields optionals[] = {_Fields.BUILD_ID,_Fields.DEBUG,_Fields.STATUS,_Fields.BUCK_VERSION,_Fields.SLAVE_INFO_BY_RUN_ID};
      ...
      if (struct.slaveInfoByRunId != null) {
        if (struct.isSetSlaveInfoByRunId()) {
          oprot.writeFieldBegin(SLAVE_INFO_BY_RUN_ID_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, BuildSlaveInfo> _iter36 : struct.slaveInfoByRunId.entrySet())
            {
      ...
      if (struct.isSetSlaveInfoByRunId()) {
        {
          ...
          for (Map.Entry<String, BuildSlaveInfo> _iter37 : struct.slaveInfoByRunId.entrySet())
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.slaveInfoByRunId = new HashMap<String,BuildSlaveInfo>(2*_map38.size);
          String _key39;
          BuildSlaveInfo _val40;
          for (int _i41 = 0; _i41 < _map38.size; ++_i41)
          {
            _key39 = iprot.readString();
            _val40 = new BuildSlaveInfo();
            _val40.read(iprot);
            struct.slaveInfoByRunId.put(_key39, _val40);
          }
        }
        struct.setSlaveInfoByRunIdIsSet(true);
      }
