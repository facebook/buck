...
public class BuildJob implements org.apache.thrift.TBase<BuildJob, BuildJob._Fields>, java.io.Serializable, Cloneable, Comparable<BuildJob> {
  ...
  public List<BuildSlaveInfo> buildSlaves; // optional
  ...
  public BuildJob(BuildJob other) {
    ...
    if (other.isSetBuildSlaves()) {
      List<BuildSlaveInfo> __this__buildSlaves = new ArrayList<BuildSlaveInfo>(other.buildSlaves.size());
  ...
  public void addToBuildSlaves(BuildSlaveInfo elem) {
    if (this.buildSlaves == null) {
      this.buildSlaves = new ArrayList<BuildSlaveInfo>();
    }
    this.buildSlaves.add(elem);
  }

  public List<BuildSlaveInfo> getBuildSlaves() {
    return this.buildSlaves;
  }

  public BuildJob setBuildSlaves(List<BuildSlaveInfo> buildSlaves) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BUILD_SLAVES:
      if (value == null) {
        ...
        setBuildSlaves((List<BuildSlaveInfo>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    boolean present_buildSlaves = true && (isSetBuildSlaves());
    list.add(present_buildSlaves);
    if (present_buildSlaves)
      list.add(buildSlaves);
  ...
  public int compareTo(BuildJob other) {
    ...
    lastComparison = Boolean.valueOf(isSetBuildSlaves()).compareTo(other.isSetBuildSlaves());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBuildSlaves()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.dotFiles = new ArrayList<PathInfo>(_list24.size);
                PathInfo _elem25;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.buildSlaves = new ArrayList<BuildSlaveInfo>(_list27.size);
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.dotFiles = new ArrayList<PathInfo>(_list34.size);
          PathInfo _elem35;
      ...
      if (incoming.get(10)) {
        {
          ...
          struct.buildSlaves = new ArrayList<BuildSlaveInfo>(_list37.size);
