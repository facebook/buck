            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.contentSha1s = new ArrayList<String>(_list56.size);
                String _elem57;
      ...
      if (struct.contentSha1s != null) {
        if (struct.isSetContentSha1s()) {
          oprot.writeFieldBegin(CONTENT_SHA1S_FIELD_DESC);
          {
            ...
            for (String _iter59 : struct.contentSha1s)
            {
      ...
      if (struct.isSetContentSha1s()) {
        {
          ...
          for (String _iter60 : struct.contentSha1s)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.contentSha1s = new ArrayList<String>(_list61.size);
          String _elem62;
