            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.contentSha1s = new ArrayList<String>(_list16.size);
                String _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = iprot.readString();
                  struct.contentSha1s.add(_elem17);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.contentSha1s != null) {
        if (struct.isSetContentSha1s()) {
          oprot.writeFieldBegin(CONTENT_SHA1S_FIELD_DESC);
          {
            ...
            for (String _iter19 : struct.contentSha1s)
            {
      ...
      if (struct.isSetContentSha1s()) {
        {
          ...
          for (String _iter20 : struct.contentSha1s)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.contentSha1s = new ArrayList<String>(_list21.size);
          String _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = iprot.readString();
            struct.contentSha1s.add(_elem22);
          }
        }
        struct.setContentSha1sIsSet(true);
      }
