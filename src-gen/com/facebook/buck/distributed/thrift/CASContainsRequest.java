            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.contentSha1s = new ArrayList<String>(_list86.size);
                String _elem87;
                for (int _i88 = 0; _i88 < _list86.size; ++_i88)
                {
                  _elem87 = iprot.readString();
                  struct.contentSha1s.add(_elem87);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.contentSha1s != null) {
        if (struct.isSetContentSha1s()) {
          oprot.writeFieldBegin(CONTENT_SHA1S_FIELD_DESC);
          {
            ...
            for (String _iter89 : struct.contentSha1s)
            {
      ...
      if (struct.isSetContentSha1s()) {
        {
          ...
          for (String _iter90 : struct.contentSha1s)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.contentSha1s = new ArrayList<String>(_list91.size);
          String _elem92;
          for (int _i93 = 0; _i93 < _list91.size; ++_i93)
          {
            _elem92 = iprot.readString();
            struct.contentSha1s.add(_elem92);
          }
        }
        struct.setContentSha1sIsSet(true);
      }
