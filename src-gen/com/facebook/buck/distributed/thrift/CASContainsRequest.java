            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.contentSha1s = new java.util.ArrayList<java.lang.String>(_list50.size);
                java.lang.String _elem51;
                for (int _i52 = 0; _i52 < _list50.size; ++_i52)
                {
                  _elem51 = iprot.readString();
                  struct.contentSha1s.add(_elem51);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.contentSha1s != null) {
        if (struct.isSetContentSha1s()) {
          oprot.writeFieldBegin(CONTENT_SHA1S_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter53 : struct.contentSha1s)
            {
      ...
      if (struct.isSetContentSha1s()) {
        {
          ...
          for (java.lang.String _iter54 : struct.contentSha1s)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.contentSha1s = new java.util.ArrayList<java.lang.String>(_list55.size);
          java.lang.String _elem56;
          for (int _i57 = 0; _i57 < _list55.size; ++_i57)
          {
            _elem56 = iprot.readString();
            struct.contentSha1s.add(_elem56);
          }
        }
        struct.setContentSha1sIsSet(true);
      }
