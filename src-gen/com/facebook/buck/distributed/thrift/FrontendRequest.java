...
public class FrontendRequest implements org.apache.thrift.TBase<FrontendRequest, FrontendRequest._Fields>, java.io.Serializable, Cloneable, Comparable<FrontendRequest> {
  ...
  public int hashCode() {
    ...
    boolean present_fetchRuleKeyLogsRequest = true && (isSetFetchRuleKeyLogsRequest());
    list.add(present_fetchRuleKeyLogsRequest);
    if (present_fetchRuleKeyLogsRequest)
      list.add(fetchRuleKeyLogsRequest);

    boolean present_storeBuildSlaveFinishedStatsRequest = true && (isSetStoreBuildSlaveFinishedStatsRequest());
    list.add(present_storeBuildSlaveFinishedStatsRequest);
    if (present_storeBuildSlaveFinishedStatsRequest)
      list.add(storeBuildSlaveFinishedStatsRequest);

    boolean present_fetchBuildSlaveFinishedStatsRequest = true && (isSetFetchBuildSlaveFinishedStatsRequest());
    list.add(present_fetchBuildSlaveFinishedStatsRequest);
    if (present_fetchBuildSlaveFinishedStatsRequest)
      list.add(fetchBuildSlaveFinishedStatsRequest);

    boolean present_setCoordinatorRequest = true && (isSetSetCoordinatorRequest());
    list.add(present_setCoordinatorRequest);
    if (present_setCoordinatorRequest)
      list.add(setCoordinatorRequest);

    boolean present_enqueueMinionsRequest = true && (isSetEnqueueMinionsRequest());
    list.add(present_enqueueMinionsRequest);
    if (present_enqueueMinionsRequest)
      list.add(enqueueMinionsRequest);

    boolean present_setFinalBuildStatusRequest = true && (isSetSetFinalBuildStatusRequest());
    list.add(present_setFinalBuildStatusRequest);
    if (present_setFinalBuildStatusRequest)
      list.add(setFinalBuildStatusRequest);

    boolean present_reportCoordinatorAliveRequest = true && (isSetReportCoordinatorAliveRequest());
    list.add(present_reportCoordinatorAliveRequest);
    if (present_reportCoordinatorAliveRequest)
      list.add(reportCoordinatorAliveRequest);
  ...
  public int compareTo(FrontendRequest other) {
    ...
    lastComparison = Boolean.valueOf(isSetFetchRuleKeyLogsRequest()).compareTo(other.isSetFetchRuleKeyLogsRequest());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetStoreBuildSlaveFinishedStatsRequest()).compareTo(other.isSetStoreBuildSlaveFinishedStatsRequest());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetFetchBuildSlaveFinishedStatsRequest()).compareTo(other.isSetFetchBuildSlaveFinishedStatsRequest());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetSetCoordinatorRequest()).compareTo(other.isSetSetCoordinatorRequest());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetEnqueueMinionsRequest()).compareTo(other.isSetEnqueueMinionsRequest());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetSetFinalBuildStatusRequest()).compareTo(other.isSetSetFinalBuildStatusRequest());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetReportCoordinatorAliveRequest()).compareTo(other.isSetReportCoordinatorAliveRequest());
    if (lastComparison != 0) {
      return lastComparison;
    }
