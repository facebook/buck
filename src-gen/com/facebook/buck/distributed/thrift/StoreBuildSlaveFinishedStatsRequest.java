...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2017-10-03")
public class StoreBuildSlaveFinishedStatsRequest implements org.apache.thrift.TBase<StoreBuildSlaveFinishedStatsRequest, StoreBuildSlaveFinishedStatsRequest._Fields>, java.io.Serializable, Cloneable, Comparable<StoreBuildSlaveFinishedStatsRequest> {
  ...
  static {
    schemes.put(StandardScheme.class, new StoreBuildSlaveFinishedStatsRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new StoreBuildSlaveFinishedStatsRequestTupleSchemeFactory());
  }
  ...
  public StoreBuildSlaveFinishedStatsRequest setBuildSlaveFinishedStats(ByteBuffer buildSlaveFinishedStats) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("StoreBuildSlaveFinishedStatsRequest(");
    boolean first = true;
  ...
  private static class StoreBuildSlaveFinishedStatsRequestStandardSchemeFactory implements SchemeFactory {
  ...
  private static class StoreBuildSlaveFinishedStatsRequestStandardScheme extends StandardScheme<StoreBuildSlaveFinishedStatsRequest> {
  ...
  private static class StoreBuildSlaveFinishedStatsRequestTupleSchemeFactory implements SchemeFactory {
    public StoreBuildSlaveFinishedStatsRequestTupleScheme getScheme() {
      return new StoreBuildSlaveFinishedStatsRequestTupleScheme();
    }
  }

  private static class StoreBuildSlaveFinishedStatsRequestTupleScheme extends TupleScheme<StoreBuildSlaveFinishedStatsRequest> {
