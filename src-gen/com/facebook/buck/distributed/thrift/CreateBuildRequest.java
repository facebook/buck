...
public class CreateBuildRequest implements org.apache.thrift.TBase<CreateBuildRequest, CreateBuildRequest._Fields>, java.io.Serializable, Cloneable, Comparable<CreateBuildRequest> {
  ...
  public String buildLabel; // optional
  ...
  public CreateBuildRequest setBuildTargets(List<String> buildTargets) {
  ...
  public CreateBuildRequest setBuildLabel(String buildLabel) {
  ...
  public int hashCode() {
    ...
    boolean present_buildLabel = true && (isSetBuildLabel());
    list.add(present_buildLabel);
    if (present_buildLabel)
      list.add(buildLabel);
  ...
  public int compareTo(CreateBuildRequest other) {
    ...
    lastComparison = Boolean.valueOf(isSetBuildLabel()).compareTo(other.isSetBuildLabel());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBuildLabel()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.buildTargets = new ArrayList<String>(_list50.size);
                String _elem51;
                for (int _i52 = 0; _i52 < _list50.size; ++_i52)
                {
                  _elem51 = iprot.readString();
                  struct.buildTargets.add(_elem51);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.buildTargets != null) {
        if (struct.isSetBuildTargets()) {
          oprot.writeFieldBegin(BUILD_TARGETS_FIELD_DESC);
          {
            ...
            for (String _iter53 : struct.buildTargets)
            {
      ...
      if (struct.isSetBuildTargets()) {
        {
          ...
          for (String _iter54 : struct.buildTargets)
          {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.buildTargets = new ArrayList<String>(_list55.size);
          String _elem56;
          for (int _i57 = 0; _i57 < _list55.size; ++_i57)
          {
            _elem56 = iprot.readString();
            struct.buildTargets.add(_elem56);
          }
        }
        struct.setBuildTargetsIsSet(true);
      }
