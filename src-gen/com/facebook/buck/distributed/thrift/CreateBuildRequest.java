            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.buildTargets = new ArrayList<String>(_list48.size);
                String _elem49;
      ...
      if (struct.buildTargets != null) {
        if (struct.isSetBuildTargets()) {
          oprot.writeFieldBegin(BUILD_TARGETS_FIELD_DESC);
          {
            ...
            for (String _iter51 : struct.buildTargets)
            {
      ...
      if (struct.isSetBuildTargets()) {
        {
          ...
          for (String _iter52 : struct.buildTargets)
          {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.buildTargets = new ArrayList<String>(_list53.size);
          String _elem54;
