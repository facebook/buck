...
public class BuildJobStateBuckConfig implements org.apache.thrift.TBase<BuildJobStateBuckConfig, BuildJobStateBuckConfig._Fields>, java.io.Serializable, Cloneable, Comparable<BuildJobStateBuckConfig> {
  ...
  public Map<String,Integer> cellAliasToIndex; // optional
  ...
  public BuildJobStateBuckConfig(BuildJobStateBuckConfig other) {
    ...
    if (other.isSetCellAliasToIndex()) {
      Map<String,Integer> __this__cellAliasToIndex = new HashMap<String,Integer>(other.cellAliasToIndex);
  ...
  public void putToCellAliasToIndex(String key, int val) {
    if (this.cellAliasToIndex == null) {
      this.cellAliasToIndex = new HashMap<String,Integer>();
    }
    this.cellAliasToIndex.put(key, val);
  }

  public Map<String,Integer> getCellAliasToIndex() {
    return this.cellAliasToIndex;
  }

  public BuildJobStateBuckConfig setCellAliasToIndex(Map<String,Integer> cellAliasToIndex) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CELL_ALIAS_TO_INDEX:
      if (value == null) {
        ...
        setCellAliasToIndex((Map<String,Integer>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    boolean present_cellAliasToIndex = true && (isSetCellAliasToIndex());
    list.add(present_cellAliasToIndex);
    if (present_cellAliasToIndex)
      list.add(cellAliasToIndex);
  ...
  public int compareTo(BuildJobStateBuckConfig other) {
    ...
    lastComparison = Boolean.valueOf(isSetCellAliasToIndex()).compareTo(other.isSetCellAliasToIndex());
    if (lastComparison != 0) {
      return lastComparison;
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.cellAliasToIndex = new HashMap<String,Integer>(2*_map11.size);
                String _key12;
                int _val13;
      ...
      if (struct.userEnvironment != null) {
        if (struct.isSetUserEnvironment()) {
          oprot.writeFieldBegin(USER_ENVIRONMENT_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter15 : struct.userEnvironment.entrySet())
            {
      ...
      if (struct.rawBuckConfig != null) {
        if (struct.isSetRawBuckConfig()) {
          oprot.writeFieldBegin(RAW_BUCK_CONFIG_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, List<OrderedStringMapEntry>> _iter16 : struct.rawBuckConfig.entrySet())
            {
      ...
      if (struct.cellAliasToIndex != null) {
        if (struct.isSetCellAliasToIndex()) {
          oprot.writeFieldBegin(CELL_ALIAS_TO_INDEX_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter18 : struct.cellAliasToIndex.entrySet())
            {
      ...
      if (struct.isSetUserEnvironment()) {
        {
          ...
          for (Map.Entry<String, String> _iter19 : struct.userEnvironment.entrySet())
          {
      ...
      if (struct.isSetRawBuckConfig()) {
        {
          ...
          for (Map.Entry<String, List<OrderedStringMapEntry>> _iter20 : struct.rawBuckConfig.entrySet())
          {
      ...
      if (struct.isSetCellAliasToIndex()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter22 : struct.cellAliasToIndex.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.userEnvironment = new HashMap<String,String>(2*_map23.size);
          String _key24;
          String _val25;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.rawBuckConfig = new HashMap<String,List<OrderedStringMapEntry>>(2*_map27.size);
          String _key28;
          List<OrderedStringMapEntry> _val29;
          for (int _i30 = 0; _i30 < _map27.size; ++_i30)
          {
            _key28 = iprot.readString();
            {
              org.apache.thrift.protocol.TList _list31 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
              _val29 = new ArrayList<OrderedStringMapEntry>(_list31.size);
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.cellAliasToIndex = new HashMap<String,Integer>(2*_map34.size);
          String _key35;
          int _val36;
