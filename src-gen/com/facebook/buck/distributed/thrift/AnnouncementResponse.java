            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.announcements = new ArrayList<Announcement>(_list98.size);
                Announcement _elem99;
                for (int _i100 = 0; _i100 < _list98.size; ++_i100)
                {
                  _elem99 = new Announcement();
                  _elem99.read(iprot);
                  struct.announcements.add(_elem99);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.announcements != null) {
        if (struct.isSetAnnouncements()) {
          oprot.writeFieldBegin(ANNOUNCEMENTS_FIELD_DESC);
          {
            ...
            for (Announcement _iter101 : struct.announcements)
            {
      ...
      if (struct.isSetAnnouncements()) {
        {
          ...
          for (Announcement _iter102 : struct.announcements)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.announcements = new ArrayList<Announcement>(_list103.size);
          Announcement _elem104;
          for (int _i105 = 0; _i105 < _list103.size; ++_i105)
          {
            _elem104 = new Announcement();
            _elem104.read(iprot);
            struct.announcements.add(_elem104);
          }
        }
        struct.setAnnouncementsIsSet(true);
      }
