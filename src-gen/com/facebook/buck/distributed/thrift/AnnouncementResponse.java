            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.announcements = new ArrayList<Announcement>(_list82.size);
                Announcement _elem83;
                for (int _i84 = 0; _i84 < _list82.size; ++_i84)
                {
                  _elem83 = new Announcement();
                  _elem83.read(iprot);
                  struct.announcements.add(_elem83);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.announcements != null) {
        if (struct.isSetAnnouncements()) {
          oprot.writeFieldBegin(ANNOUNCEMENTS_FIELD_DESC);
          {
            ...
            for (Announcement _iter85 : struct.announcements)
            {
              _iter85.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetAnnouncements()) {
        {
          ...
          for (Announcement _iter86 : struct.announcements)
          {
            _iter86.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.announcements = new ArrayList<Announcement>(_list87.size);
          Announcement _elem88;
          for (int _i89 = 0; _i89 < _list87.size; ++_i89)
          {
            _elem88 = new Announcement();
            _elem88.read(iprot);
            struct.announcements.add(_elem88);
          }
        }
        struct.setAnnouncementsIsSet(true);
      }
