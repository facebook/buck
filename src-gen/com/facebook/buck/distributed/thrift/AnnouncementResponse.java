            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.announcements = new java.util.ArrayList<Announcement>(_list130.size);
                Announcement _elem131;
                for (int _i132 = 0; _i132 < _list130.size; ++_i132)
                {
                  _elem131 = new Announcement();
                  _elem131.read(iprot);
                  struct.announcements.add(_elem131);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.announcements != null) {
        if (struct.isSetAnnouncements()) {
          oprot.writeFieldBegin(ANNOUNCEMENTS_FIELD_DESC);
          {
            ...
            for (Announcement _iter133 : struct.announcements)
            {
      ...
      if (struct.isSetAnnouncements()) {
        {
          ...
          for (Announcement _iter134 : struct.announcements)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.announcements = new java.util.ArrayList<Announcement>(_list135.size);
          Announcement _elem136;
          for (int _i137 = 0; _i137 < _list135.size; ++_i137)
          {
            _elem136 = new Announcement();
            _elem136.read(iprot);
            struct.announcements.add(_elem136);
          }
        }
        struct.setAnnouncementsIsSet(true);
      }
