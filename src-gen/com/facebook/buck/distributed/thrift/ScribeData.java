            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.lines = new ArrayList<String>(_list16.size);
                String _elem17;
      ...
      if (struct.lines != null) {
        if (struct.isSetLines()) {
          oprot.writeFieldBegin(LINES_FIELD_DESC);
          {
            ...
            for (String _iter19 : struct.lines)
            {
      ...
      if (struct.isSetLines()) {
        {
          ...
          for (String _iter20 : struct.lines)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.lines = new ArrayList<String>(_list21.size);
          String _elem22;
