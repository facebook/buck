...
public interface ResolvedJavacOptionsOrBuilder extends
   ...
   */
  java.util.List<com.facebook.buck.cd.model.java.ResolvedJavacOptions.JavacPluginJsr199Fields> 
      getAnnotationProcessorsList();
  /**
   * <code>repeated .javacd.api.v1.ResolvedJavacOptions.JavacPluginJsr199Fields annotationProcessors = 9;</code>
   */
  com.facebook.buck.cd.model.java.ResolvedJavacOptions.JavacPluginJsr199Fields getAnnotationProcessors(int index);
  /**
   * <code>repeated .javacd.api.v1.ResolvedJavacOptions.JavacPluginJsr199Fields annotationProcessors = 9;</code>
   */
   ...
   * <code>repeated .javacd.api.v1.ResolvedJavacOptions.JavacPluginJsr199Fields annotationProcessors = 9;</code>
   */
  java.util.List<? extends com.facebook.buck.cd.model.java.ResolvedJavacOptions.JavacPluginJsr199FieldsOrBuilder> 
      getAnnotationProcessorsOrBuilderList();
  /**
   * <code>repeated .javacd.api.v1.ResolvedJavacOptions.JavacPluginJsr199Fields annotationProcessors = 9;</code>
   */
  com.facebook.buck.cd.model.java.ResolvedJavacOptions.JavacPluginJsr199FieldsOrBuilder getAnnotationProcessorsOrBuilder(
      int index);
   ...
   * <code>repeated .javacd.api.v1.ResolvedJavacOptions.JavacPluginJsr199Fields javaPlugins = 10;</code>
   */
  com.facebook.buck.cd.model.java.ResolvedJavacOptions.JavacPluginJsr199Fields getJavaPlugins(int index);
  /**
   * <code>repeated .javacd.api.v1.ResolvedJavacOptions.JavacPluginJsr199Fields javaPlugins = 10;</code>
   */
   ...
   * <code>repeated .javacd.api.v1.ResolvedJavacOptions.JavacPluginJsr199Fields javaPlugins = 10;</code>
   */
  com.facebook.buck.cd.model.java.ResolvedJavacOptions.JavacPluginJsr199FieldsOrBuilder getJavaPluginsOrBuilder(
      int index);
