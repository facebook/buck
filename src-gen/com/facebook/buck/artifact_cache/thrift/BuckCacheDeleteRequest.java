...
public class BuckCacheDeleteRequest implements org.apache.thrift.TBase<BuckCacheDeleteRequest, BuckCacheDeleteRequest._Fields>, java.io.Serializable, Cloneable, Comparable<BuckCacheDeleteRequest> {
  ...
  public BuckCacheDeleteRequest setRuleKeys(java.util.List<RuleKey> ruleKeys) {
  ...
  public BuckCacheDeleteRequest setRepository(java.lang.String repository) {
  ...
  public BuckCacheDeleteRequest setScheduleType(java.lang.String scheduleType) {
  ...
  public BuckCacheDeleteRequest setDistributedBuildModeEnabled(boolean distributedBuildModeEnabled) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ruleKeys = new java.util.ArrayList<RuleKey>(_list50.size);
                RuleKey _elem51;
                for (int _i52 = 0; _i52 < _list50.size; ++_i52)
                {
                  _elem51 = new RuleKey();
                  _elem51.read(iprot);
                  struct.ruleKeys.add(_elem51);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.ruleKeys != null) {
        if (struct.isSetRuleKeys()) {
          oprot.writeFieldBegin(RULE_KEYS_FIELD_DESC);
          {
            ...
            for (RuleKey _iter53 : struct.ruleKeys)
            {
              _iter53.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetRuleKeys()) {
        {
          ...
          for (RuleKey _iter54 : struct.ruleKeys)
          {
            _iter54.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.ruleKeys = new java.util.ArrayList<RuleKey>(_list55.size);
          RuleKey _elem56;
          for (int _i57 = 0; _i57 < _list55.size; ++_i57)
          {
            _elem56 = new RuleKey();
            _elem56.read(iprot);
            struct.ruleKeys.add(_elem56);
          }
        }
        struct.setRuleKeysIsSet(true);
      }
