...
public class BuckCacheRequest implements org.apache.thrift.TBase<BuckCacheRequest, BuckCacheRequest._Fields>, java.io.Serializable, Cloneable, Comparable<BuckCacheRequest> {
  ...
  private static final _Fields optionals[] = {_Fields.TYPE,_Fields.PAYLOADS,_Fields.FETCH_REQUEST,_Fields.STORE_REQUEST,_Fields.MULTI_FETCH_REQUEST,_Fields.DELETE_REQUEST};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.payloads = new java.util.ArrayList<PayloadInfo>(_list66.size);
                PayloadInfo _elem67;
                for (int _i68 = 0; _i68 < _list66.size; ++_i68)
                {
                  _elem67 = new PayloadInfo();
                  _elem67.read(iprot);
                  struct.payloads.add(_elem67);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.payloads != null) {
        if (struct.isSetPayloads()) {
          oprot.writeFieldBegin(PAYLOADS_FIELD_DESC);
          {
            ...
            for (PayloadInfo _iter69 : struct.payloads)
            {
              _iter69.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetPayloads()) {
        {
          ...
          for (PayloadInfo _iter70 : struct.payloads)
          {
            _iter70.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.payloads = new java.util.ArrayList<PayloadInfo>(_list71.size);
          PayloadInfo _elem72;
          for (int _i73 = 0; _i73 < _list71.size; ++_i73)
          {
            _elem72 = new PayloadInfo();
            _elem72.read(iprot);
            struct.payloads.add(_elem72);
          }
        }
        struct.setPayloadsIsSet(true);
      }
