...
public class BuckCacheResponse implements org.apache.thrift.TBase<BuckCacheResponse, BuckCacheResponse._Fields>, java.io.Serializable, Cloneable, Comparable<BuckCacheResponse> {
  ...
  private static final _Fields optionals[] = {_Fields.WAS_SUCCESSFUL,_Fields.ERROR_MESSAGE,_Fields.TYPE,_Fields.PAYLOADS,_Fields.FETCH_RESPONSE,_Fields.STORE_RESPONSE,_Fields.MULTI_FETCH_RESPONSE,_Fields.DELETE_RESPONSE};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.payloads = new java.util.ArrayList<PayloadInfo>(_list74.size);
                PayloadInfo _elem75;
                for (int _i76 = 0; _i76 < _list74.size; ++_i76)
                {
                  _elem75 = new PayloadInfo();
                  _elem75.read(iprot);
                  struct.payloads.add(_elem75);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.payloads != null) {
        if (struct.isSetPayloads()) {
          oprot.writeFieldBegin(PAYLOADS_FIELD_DESC);
          {
            ...
            for (PayloadInfo _iter77 : struct.payloads)
            {
              _iter77.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetPayloads()) {
        {
          ...
          for (PayloadInfo _iter78 : struct.payloads)
          {
            _iter78.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.payloads = new java.util.ArrayList<PayloadInfo>(_list79.size);
          PayloadInfo _elem80;
          for (int _i81 = 0; _i81 < _list79.size; ++_i81)
          {
            _elem80 = new PayloadInfo();
            _elem80.read(iprot);
            struct.payloads.add(_elem80);
          }
        }
        struct.setPayloadsIsSet(true);
      }
