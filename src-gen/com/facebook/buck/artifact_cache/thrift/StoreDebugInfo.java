            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.storesWrittenInto = new ArrayList<String>(_list26.size);
                String _elem27;
      ...
      if (struct.isSetStoresWrittenInto()) {
        {
          ...
          for (String _iter30 : struct.storesWrittenInto)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.storesWrittenInto = new ArrayList<String>(_list31.size);
          String _elem32;
