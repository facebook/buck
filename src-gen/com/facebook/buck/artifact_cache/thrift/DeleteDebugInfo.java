            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.storesDeletedFrom = new java.util.ArrayList<java.lang.String>(_list58.size);
                java.lang.String _elem59;
                for (int _i60 = 0; _i60 < _list58.size; ++_i60)
                {
                  _elem59 = iprot.readString();
                  struct.storesDeletedFrom.add(_elem59);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.storesDeletedFrom != null) {
        if (struct.isSetStoresDeletedFrom()) {
          oprot.writeFieldBegin(STORES_DELETED_FROM_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter61 : struct.storesDeletedFrom)
            {
      ...
      if (struct.isSetStoresDeletedFrom()) {
        {
          ...
          for (java.lang.String _iter62 : struct.storesDeletedFrom)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.storesDeletedFrom = new java.util.ArrayList<java.lang.String>(_list63.size);
          java.lang.String _elem64;
          for (int _i65 = 0; _i65 < _list63.size; ++_i65)
          {
            _elem64 = iprot.readString();
            struct.storesDeletedFrom.add(_elem64);
          }
        }
        struct.setStoresDeletedFromIsSet(true);
      }
