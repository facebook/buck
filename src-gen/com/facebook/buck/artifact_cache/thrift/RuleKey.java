...
public class RuleKey implements org.apache.thrift.TBase<RuleKey, RuleKey._Fields>, java.io.Serializable, Cloneable, Comparable<RuleKey> {
  ...
  static {
    schemes.put(StandardScheme.class, new RuleKeyStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RuleKeyTupleSchemeFactory());
  }

  public String hashString; // optional
  ...
  public RuleKey setHashString(String hashString) {
  ...
  public int hashCode() {
    ...
    boolean present_hashString = true && (isSetHashString());
    list.add(present_hashString);
    if (present_hashString)
      list.add(hashString);
  ...
  public int compareTo(RuleKey other) {
    ...
    lastComparison = Boolean.valueOf(isSetHashString()).compareTo(other.isSetHashString());
    if (lastComparison != 0) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RuleKey(");
    boolean first = true;
  ...
  private static class RuleKeyStandardSchemeFactory implements SchemeFactory {
    public RuleKeyStandardScheme getScheme() {
      return new RuleKeyStandardScheme();
    }
  }

  private static class RuleKeyStandardScheme extends StandardScheme<RuleKey> {
  ...
  private static class RuleKeyTupleSchemeFactory implements SchemeFactory {
    public RuleKeyTupleScheme getScheme() {
      return new RuleKeyTupleScheme();
    }
  }

  private static class RuleKeyTupleScheme extends TupleScheme<RuleKey> {
