...
public class Digest implements org.apache.thrift.TBase<Digest, Digest._Fields>, java.io.Serializable, Cloneable, Comparable<Digest> {
  ...
  private static final org.apache.thrift.protocol.TField SIZE_BYTES_FIELD_DESC = new org.apache.thrift.protocol.TField("size_bytes", org.apache.thrift.protocol.TType.I64, (short)2);
  ...
  public long size_bytes; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    HASH((short)1, "hash"),
    SIZE_BYTES((short)2, "size_bytes");
  ...
  static {
    ...
    tmpMap.put(_Fields.SIZE_BYTES, new org.apache.thrift.meta_data.FieldMetaData("size_bytes", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public void unsetSize_bytes() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __SIZE_BYTES_ISSET_ID);
  }

  /** Returns true if field size_bytes is set (has been assigned a value) and false otherwise */
  public boolean isSetSize_bytes() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __SIZE_BYTES_ISSET_ID);
  }

  public void setSize_bytesIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __SIZE_BYTES_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case SIZE_BYTES:
      if (value == null) {
        ...
        setSize_bytes((java.lang.Long)value);
      }
      break;
  ...
  public boolean equals(Digest that) {
    ...
    if (this_present_size_bytes || that_present_size_bytes) {
      if (!(this_present_size_bytes && that_present_size_bytes))
        return false;
      if (this.size_bytes != that.size_bytes)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(size_bytes);
  ...
  public int compareTo(Digest other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSize_bytes()).compareTo(other.isSetSize_bytes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSize_bytes()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.size_bytes, other.size_bytes);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class DigestStandardScheme extends org.apache.thrift.scheme.StandardScheme<Digest> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // SIZE_BYTES
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.size_bytes = iprot.readI64();
              struct.setSize_bytesIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Digest struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.size_bytes);
      oprot.writeFieldEnd();
