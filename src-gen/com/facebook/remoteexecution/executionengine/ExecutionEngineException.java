...
public class ExecutionEngineException extends Exception implements TBase, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("ExecutionEngineException");
  ...
  /**
   * 
   * @see ExecutionEngineExceptionCode
   */
  public int code;
  ...
  static {
    FieldMetaData.addStructMetaDataMap(ExecutionEngineException.class, metaDataMap);
  }
   ...
   */
  public ExecutionEngineException(ExecutionEngineException other) {
  ...
  public ExecutionEngineException deepCopy() {
    return new ExecutionEngineException(this);
  }

  @Deprecated
  public ExecutionEngineException clone() {
    return new ExecutionEngineException(this);
  }
   ...
   * @see ExecutionEngineExceptionCode
   */
  public ExecutionEngineException setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public ExecutionEngineException setMessage(String message) {
    this.message = message;
    return this;
  }
  ...
  public ExecutionEngineException setDetails(List<String> details) {
    this.details = details;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ExecutionEngineException)
      return this.equals((ExecutionEngineException)that);
    return false;
  }

  public boolean equals(ExecutionEngineException that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.details = new ArrayList<String>(Math.max(0, _list32.size));
              for (int _i33 = 0; 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.details != null) {
      oprot.writeFieldBegin(DETAILS_FIELD_DESC);
      {
        ...
        for (String _iter35 : this.details)        {
...
String space = prettyPrint ? " " : "";
    StringBuilder sb = new StringBuilder("ExecutionEngineException");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
    ...
    String code_name = ExecutionEngineExceptionCode.VALUES_TO_NAMES.get(this. getCode());
    if (code_name != null) {
      sb.append(code_name);
      sb.append(" (");
    }
  ...
  public void validate() throws TException {
    ...
    if (isSetCode() && !ExecutionEngineExceptionCode.VALID_VALUES.contains(code)){
