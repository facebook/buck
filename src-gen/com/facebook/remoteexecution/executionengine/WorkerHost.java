...
public class WorkerHost implements TBase, java.io.Serializable, Cloneable, Comparable<WorkerHost> {
  private static final TStruct STRUCT_DESC = new TStruct("WorkerHost");
  ...
  static {
    ...
    tmpMetaDataMap.put(DEVICES, new FieldMetaData("devices", TFieldRequirementType.DEFAULT, 
        new ListMetaData(TType.LIST, 
            new StructMetaData(TType.STRUCT, Device.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMetaDataMap);
  }

  static {
    FieldMetaData.addStructMetaDataMap(WorkerHost.class, metaDataMap);
  }
  ...
  public WorkerHost setProperties(List<Property> properties) {
    this.properties = properties;
    return this;
  }
  ...
  public WorkerHost setResources(List<Resource> resources) {
    this.resources = resources;
    return this;
  }
  ...
  public WorkerHost setDevices(List<Device> devices) {
    this.devices = devices;
    return this;
  }
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.properties = new ArrayList<Property>(Math.max(0, _list4.size));
              for (int _i5 = 0; 
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.resources = new ArrayList<Resource>(Math.max(0, _list7.size));
              for (int _i8 = 0; 
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.devices = new ArrayList<Device>(Math.max(0, _list10.size));
              for (int _i11 = 0; 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.properties != null) {
      oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
      {
        ...
        for (Property _iter13 : this.properties)        {
          _iter13.write(oprot);
        }
        oprot.writeListEnd();
      }
    ...
    if (this.resources != null) {
      oprot.writeFieldBegin(RESOURCES_FIELD_DESC);
      {
        ...
        for (Resource _iter14 : this.resources)        {
          _iter14.write(oprot);
        }
        oprot.writeListEnd();
      }
    ...
    if (this.devices != null) {
      oprot.writeFieldBegin(DEVICES_FIELD_DESC);
      {
        ...
        for (Device _iter15 : this.devices)        {
          _iter15.write(oprot);
        }
        oprot.writeListEnd();
      }
...
String space = prettyPrint ? " " : "";
    StringBuilder sb = new StringBuilder("WorkerHost");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
