...
public class RequiredDevice implements TBase, java.io.Serializable, Cloneable, Comparable<RequiredDevice> {
  private static final TStruct STRUCT_DESC = new TStruct("RequiredDevice");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(RequiredDevice.class, metaDataMap);
  }
  ...
  public RequiredDevice setProperties(List<Property> properties) {
    this.properties = properties;
    return this;
  }
...
String space = prettyPrint ? " " : "";
    StringBuilder sb = new StringBuilder("RequiredDevice");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
