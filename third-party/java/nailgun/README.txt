nailgun-server-1.0.0-SNAPSHOT.jar and nailgun-server-1.0.0-SNAPSHOT-sources.jar were
...
To regenerate these jars:
 ...
 4) mvn clean package
 5) copy nailgun-server/target/nailgun-server-1.0.0-SNAPSHOT.jar and
    nailgun-server/target/nailgun-server-1.0.0-SNAPSHOT-sources.jar to your buck/third-party/java/nailgun directory
