...
public class DefaultJavaLibraryIntegrationTest extends AbiCompilationModeTest {
  ...
  public void testSaveClassFilesToDisk() throws IOException {
    ...
    Path classesDir =
        workspace.getPath(BuildTargetPaths.getScratchPath(filesystem, target, "lib__%s__classes"));
  ...
  public void testSpoolClassFilesDirectlyToJar() throws IOException {
    ...
    Path jarPath =
        workspace.getPath(BuildTargetPaths.getGenPath(filesystem, target, "lib__%s__output/a.jar"));
  ...
  public void testSpoolClassFilesDirectlyToJarWithAnnotationProcessorAndRemoveClasses()
    ...
    Path sourcesDir =
        workspace.getPath(BuildTargetPaths.getAnnotationPath(filesystem, target, "__%s_gen__"));
