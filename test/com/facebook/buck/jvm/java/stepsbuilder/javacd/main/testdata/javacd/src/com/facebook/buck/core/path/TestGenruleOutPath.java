 ...
 */
public class TestGenruleOutPath {
  private String path;

  private TestGenruleOutPath(String s) {
    this.path = s;
  }
   ...
   */
  public static TestGenruleOutPath of(String s) {
    try {
      assertValid(s);
    ...
    return new TestGenruleOutPath(s);
  }
  ...
  public static String stringMapper(TestGenruleOutPath p) {
    return p.toString();
  }
}
