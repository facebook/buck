...
public class DefaultJavaLibraryTest extends AbiCompilationModeTest {
  ...
  public void testDepFilePredicateForNoAnnotationProcessorDeps() {
    ...
    assertFalse(
        ...
        libraryTwo
            .getCoveredByDepFilePredicate(DefaultSourcePathResolver.from(graphBuilder))
            .test(sourcePath));
  }
  ...
  private BuildContext createBuildContext() {
    return FakeBuildContext.withSourcePathResolver(DefaultSourcePathResolver.from(graphBuilder));
  }
