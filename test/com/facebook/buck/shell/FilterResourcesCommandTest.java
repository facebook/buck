...
public class FilterResourcesCommandTest {
  ...
  public void testFilterResourcesCommand() {
    ...
    FilterResourcesCommand.DrawableFinder finder = EasyMock.createMock(
        FilterResourcesCommand.DrawableFinder.class);
    ...
    FilterResourcesCommand command = new FilterResourcesCommand(
        resDirectories,
        baseDestination,
        targetDensity,
        copier,
