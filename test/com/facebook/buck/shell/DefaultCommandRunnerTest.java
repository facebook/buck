...
public class DefaultCommandRunnerTest {
  @Test(expected=CommandFailedException.class, timeout=1000)
  ...
  private static class SleepingCommand implements Command {
    private final long sleepMillis;
    private final int exitCode;

    public SleepingCommand(long sleepMillis, int exitCode) {
