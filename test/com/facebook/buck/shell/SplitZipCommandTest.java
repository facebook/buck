...
public class SplitZipCommandTest {
  @Rule
  ...
  public void testMetaList() throws IOException {
    ...
    try {
      SplitZipCommand.writeMetaList(writer, ImmutableList.of(outJar));
    } finally {
      writer.close();
    }
    ...
    assertEquals(SmartDexingCommand.transformInputToDexOutput(outJar.getName()), data[0]);
  ...
  public void testClassFilePattern() {
    assertTrue(SplitZipCommand.classFilePattern.matcher(
