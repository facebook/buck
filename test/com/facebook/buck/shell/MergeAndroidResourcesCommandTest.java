...
import com.facebook.buck.shell.MergeAndroidResourcesCommand.Resource;
...
public class MergeAndroidResourcesCommandTest {
  @Test
  public void testGenerateRDotJavaForMultipleSymbolsFiles() throws IOException {
    ...
    SortedSetMultimap<String, Resource> packageNameToResources =
        MergeAndroidResourcesCommand.sortSymbols(
  ...
  public void testGenerateRDotJavaForOneSymbolsFile() {
    ...
    String javaCode = MergeAndroidResourcesCommand.generateJavaCodeForPackageAndResources(
  ...
  public void testGenerateRDotJavaForEmptyResources() {
    ...
    String rDotJava = MergeAndroidResourcesCommand.generateJavaCodeForPackageWithoutResources(
        packageName);
    assertEquals(
        "package com.facebook;\n" +
        "\n" +
