...
public class ReadKeystorePropertiesAndSignApkCommandTest {
  ...
  public void testSetup() throws IOException {
    ...
    ReadKeystorePropertiesAndSignApkCommand readKeystorePropertiesAndSignCommand =
        new ReadKeystorePropertiesAndSignApkCommand(
          pathToPropertiesFile,
          unsignedApkPath,
          outputPath,
            projectFilesystem);
    readKeystorePropertiesAndSignCommand.setup(context);
    SignApkCommand signApkCommand = readKeystorePropertiesAndSignCommand.getSignApkCommand();
