...
public class SwiftLibraryIntegrationTest {
  ...
  public void testEmitModuleDocArgsAreIncludedInCompilerCommand() {
    assumeThat(
      ...
      ImmutableList<String> compilerCommand = ImmutableList.copyOf(
          compileStep.getDescription(null).split(" "));

      String expectedSwiftdocPath = ExplicitBuildTargetSourcePath.of(
          swiftCompileTarget,
          pathResolver
              .getRelativePath(buildRule.getSourcePathToOutput())
              .resolve("bar.swiftdoc"))
          .getResolvedPath().toString();
      assertThat(
          compilerCommand,
