...
public class NlistTest {
  ...
  public void testCreatingFromBytes32BitBigEndian() {
    Nlist nlist = NlistUtils.createFromBuffer(
        byteBufferWithBytesOrderAndPosition(
            NlistTestData.getBigEndian32Bit(),
  ...
  public void testCreatingFromBytes32BitLittleEndian() {
    Nlist nlist = NlistUtils.createFromBuffer(
        byteBufferWithBytesOrderAndPosition(
            NlistTestData.getLittleEndian32Bit(),
  ...
  public void testCreatingFromBytes64BitBigEndian() {
    Nlist nlist = NlistUtils.createFromBuffer(
        byteBufferWithBytesOrderAndPosition(
            NlistTestData.getBigEndian64Bit(),
            ByteOrder.BIG_ENDIAN,
            12),
        true);
  ...
  public void testCreatingFromBytes64BitLittleEndian() {
    Nlist nlist = NlistUtils.createFromBuffer(
        byteBufferWithBytesOrderAndPosition(
            NlistTestData.getLittleEndian64Bit(),
            ByteOrder.LITTLE_ENDIAN,
            13),
        true);
  ...
  public void testConvertingToBytes32BitBigEndian() {
    Nlist nlist = NlistUtils.createFromBuffer(
        byteBufferWithBytesOrderAndPosition(
            ...
            0),
        false);
    ByteBuffer bigEndian = ByteBuffer.allocate(Nlist.SIZE_IN_BYTES_32_BIT)
        .order(ByteOrder.BIG_ENDIAN);
    NlistUtils.writeNlistToBuffer(nlist, bigEndian, false);
    ByteBuffer littleEndian = ByteBuffer.allocate(Nlist.SIZE_IN_BYTES_32_BIT)
  ...
  public void testConvertingToBytes64BitBigEndian() {
    Nlist nlist = NlistUtils.createFromBuffer(
        byteBufferWithBytesOrderAndPosition(
            ...
            10),
        true);
    ByteBuffer bigEndian = ByteBuffer.allocate(Nlist.SIZE_IN_BYTES_64_BIT)
        .order(ByteOrder.BIG_ENDIAN);
    NlistUtils.writeNlistToBuffer(nlist, bigEndian, true);
    ByteBuffer littleEndian = ByteBuffer.allocate(Nlist.SIZE_IN_BYTES_64_BIT)
        .order(ByteOrder.LITTLE_ENDIAN);
