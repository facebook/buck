...
public class ConfigDifferenceTest {
  ...
  public void compareNotEqualConfigs() {
    ...
    assertEquals(
        ...
        ImmutableMap.of(
            "section1.field1", new ImmutableConfigChange("diffValue1", "diffValue2"),
            "section3.onlyOnLeft", new ImmutableConfigChange("someValue", null),
            "section4.onlyOnLeft", new ImmutableConfigChange("someValue", null),
            "section5.onlyOnRight", new ImmutableConfigChange(null, "someValue")));
  }
}
