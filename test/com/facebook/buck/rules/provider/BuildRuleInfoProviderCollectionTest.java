...
public class BuildRuleInfoProviderCollectionTest {
  ...
  public void missingProviderThrows() {
    ...
    BuildRule buildRule =
        new FakeBuildRuleWithProviders(
            buildTarget, projectFilesystem, BuildRuleInfoProviderCollection.builder().build());
  ...
  public void findsCorrectProviders() {
    ...
    BuildRuleInfoProviderCollection.Builder providers =
        BuildRuleInfoProviderCollection.builder().put(fakeProvider).put(anotherFakeProvider);
    BuildRule buildRule =
        new FakeBuildRuleWithProviders(buildTarget, projectFilesystem, providers.build());
