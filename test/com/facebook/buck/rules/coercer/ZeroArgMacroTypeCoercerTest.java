...
public class ZeroArgMacroTypeCoercerTest {
  ...
  public void test() throws CoerceFailedException {
    ...
    ZeroArgMacro result =
        coercer.coerce(createCellRoots(filesystem), filesystem, basePath, ImmutableList.of());
  ...
  public void testIncorrectArgs() throws CoerceFailedException {
    ...
    coercer.coerce(createCellRoots(filesystem), filesystem, basePath, ImmutableList.of("arg"));
  }
