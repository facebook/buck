...
public class ProjectGeneratorTest {
  ...
  public void shouldNotCreateHeaderMapsWhenHeaderMapsAreDisabled() throws IOException {
    ...
    TargetNode<?> node = AppleLibraryBuilder
        ...
        .setSrcs(
            Optional.of(
                ImmutableList.of(
                    AppleSource.of(new TestSourcePath("HeaderGroup1/foo.h")),
                    AppleSource.of(
  ...
  public void testAppleLibraryDependentsSearchHeadersAndLibraries() throws IOException {
    ...
    TargetNode<?> libraryNode = AppleLibraryBuilder
        ...
        .setSrcs(
            Optional.of(ImmutableList.of(AppleSource.of(new TestSourcePath("foo.m")))))
    ...
    TargetNode<?> testNode = AppleTestBuilder
        ...
        .setSrcs(
            Optional.of(
                ImmutableList.of(AppleSource.of(new TestSourcePath("fooTest.m")))))
