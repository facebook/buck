...
public class ProjectGeneratorTest {
  ...
  public void testGenerateOnlyHeaderSymlinkTrees() throws IOException {
    ...
    assertFalse(projectGenerator.getProjectPath() + " should not be generated.",
  ...
  public void testResolvingExportFile() throws IOException {
    ...
    TargetNode<AppleLibraryDescription.Arg, ?> library = AppleLibraryBuilder
        ...
        .setSrcs(
            ImmutableSortedSet.of(
                SourceWithFlags.of(
                    new DefaultBuildTargetSourcePath(source1Target)),
                SourceWithFlags.of(
                    new DefaultBuildTargetSourcePath(source2RefTarget)),
                SourceWithFlags.of(
                    new DefaultBuildTargetSourcePath(source3Target))))
        .setPrefixHeader(
            Optional.of(new DefaultBuildTargetSourcePath(headerTarget)))
        .build();
