  ...
  public void testHelpCommandFinishedSuccessfully() throws IOException {
    ...
    result.assertSuccess(
        linesToText(
            ...
            "  cquery         provides facilities to query information about the configured target nodes graph",
            ...
            "  query          provides facilities to query information about the configured target nodes graph (see - cquery)",
