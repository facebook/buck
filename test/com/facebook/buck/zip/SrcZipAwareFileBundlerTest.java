...
public class SrcZipAwareFileBundlerTest {
  ...
  public void shouldThrowAnExceptionIfAnInputIsADirectory() throws IOException {

    ProjectFilesystem filesystem = FakeProjectFilesystem.createJavaOnlyFilesystem();
    Path src = filesystem.getRootPath().resolve("src");
    Path dest = filesystem.getRootPath().resolve("dest");
