...
public class DefaultOnDiskInfoPreparer {
  ...
  public DefaultOnDiskInfoPreparer(TemporaryPaths tmp) throws IOException {
    ...
    recorder.addMetadata(BuildInfo.MetadataKey.OUTPUT_SIZE, Long.toString(outputSize));
    recorder.addBuildMetadata(BuildInfo.MetadataKey.ORIGIN_BUILD_ID, "build-id");
