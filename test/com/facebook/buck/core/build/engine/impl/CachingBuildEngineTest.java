...
public class CachingBuildEngineTest {
          ...
          new InputRuleKeyBuildRule(target, filesystem, params) {
            ...
            public ImmutableList<Step> getBuildSteps(
              ...
              return ImmutableList.of(
                  WriteFileIsolatedStep.of("12345", output, /* executable */ false));
            }
    ...
    public void inputBasedRuleKeyAndArtifactAreWrittenForSupportedRules() throws Exception {
      ...
      BuildRule rule =
          new InputRuleKeyBuildRule(target, filesystem, params) {
            ...
            public ImmutableList<Step> getBuildSteps(
                BuildContext context, BuildableContext buildableContext) {
              return ImmutableList.of(WriteFileIsolatedStep.of("", output, /* executable */ false));
            }
  ...
  public static class DepFileTests extends CommonFixture {
    ...
    public void depFileRuleKeyAndDepFileAreWrittenForSupportedRules() throws Exception {
      ...
      RuleKey depFileRuleKey =
          depFileFactory
              .build(
                  rule, ImmutableList.of(DependencyFileEntry.of(input.getPath(), Optional.empty())))
              .getRuleKey();
      BuildResult result =
          cachingBuildEngine
              .build(
    ...
    public void depFileRuleKeyMatchAvoidsBuilding() throws Exception {
      ...
      RelPath input = RelPath.get("input_file");
      filesystem.touch(input.getPath());
    ...
    public void depFileInputChangeCausesRebuild() throws Exception {
      ...
      fileHashCache.invalidate(filesystem.resolve(input).getPath());
    ...
    public void depFileDeletedInputCausesRebuild() throws Exception {
      ...
      filesystem.deleteFileAtPath(input.getPath());
      fileHashCache.invalidate(filesystem.resolve(input).getPath());
  ...
  private static String fileToDepFileEntryString(RelPath file) {
    DependencyFileEntry entry = DependencyFileEntry.of(file.getPath(), Optional.empty());
