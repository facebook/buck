...
public class ExcludeFolderTest extends IjFolderTest {

  @Before
  @Override
  public void setupFolderFactory() {
    folderFactory = ExcludeFolder.FACTORY;
  }

  @Test(expected = IllegalArgumentException.class)
  public void testMergingExcludeWithSourceFails() {
    testMerge(SourceFolder.FACTORY);
  }
