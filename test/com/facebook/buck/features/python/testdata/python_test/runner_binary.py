...
"""
The majority of this file is copied from __test__main.py, which lives in buck/src/com/facebook/buck/features/python as of the time this file was copied.

The only difference between this file and __test_main.py is that this file prints "hello runner" before doing anything else.
"""
