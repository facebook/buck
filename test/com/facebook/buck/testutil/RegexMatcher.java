...
public class RegexMatcher extends TypeSafeMatcher<CharSequence> {
  ...
  public void describeMismatchSafely(CharSequence charSequence, Description mismatchDescription) {
    mismatchDescription.appendText("was \"").appendText(charSequence.toString()).appendText("\"");
  }
  ...
  /**
   * Creates a matcher that checks if the examined {@link CharSequence} matches the specified {@link
   * Pattern}.
   *
   * <p>For example:
   *
   ...
   *
   * @param pattern the pattern that the returned matcher will use to match any examined {@link
   *     CharSequence}
   */
   ...
   *
   * @param regex the regular expression that the returned matcher will use to match any examined
   *     {@link CharSequence}
   */
   ...
   *
   * @param pattern the pattern that the returned matcher will use to find a match in any examined
   *     {@link CharSequence}
   */
   ...
   *
   * @param regex the regular expression that the returned matcher will use to find a match in any
