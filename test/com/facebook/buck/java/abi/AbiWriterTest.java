...
public class AbiWriterTest {
  ...
  /**
   * @return the summary of the last source file.
   */
  private String compile(String fileName, String source, String... fileNamesAndSources)
      throws IOException {
    ArrayList<FileAndSource> targets = Lists.newArrayList();
    ...
    for (FileAndSource target : targets) {
      ...
      lastSummary = compileSingle(outputDir, target, classpath.build());
      classpath.add(outputDir);
    }
    return lastSummary;
  }

  private String compileSingle(File outputDir, FileAndSource target, ImmutableSet<File> classpath)
      throws IOException{
