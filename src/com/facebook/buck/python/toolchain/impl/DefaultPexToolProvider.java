...
public class DefaultPexToolProvider implements PexToolProvider {
  ...
  public DefaultPexToolProvider(
      PythonBuckConfig pythonBuckConfig, RuleKeyConfiguration ruleKeyConfiguration) {
  ...
  private Tool getRawPexTool(
    ...
    return VersionedTool.builder()
        ...
        .setPath(pythonBuckConfig.getPythonInterpreter(pythonBuckConfig.getDefaultSection()))
