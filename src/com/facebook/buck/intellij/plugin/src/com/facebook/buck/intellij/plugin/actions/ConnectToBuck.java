...
public class ConnectToBuck  extends DumbAwareAction {
    public static final String ACTION_TITLE = "Connect to buck";
    public static final String ACTION_DESCRIPTION = "Connect to buck";

    public ConnectToBuck() {
