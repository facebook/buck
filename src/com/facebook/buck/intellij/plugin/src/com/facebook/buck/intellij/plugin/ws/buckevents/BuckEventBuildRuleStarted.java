...
public class BuckEventBuildRuleStarted extends BuckEventBuildRuleBase {
    public static final String EVENT_TYPE = "BuildRuleStarted";
    @Override
    public void handleEvent(BuckEventsConsumerFactory notifier) {
        BuildRuleStartConsumer publisher = notifier.getBuildRuleStartConsumer();
        String target = buildRule.name;
        publisher.consumeBuildRuleStart(buildId, ruleKeySafe, target, timestamp, false);
    }
