...
/** Holds data about the distributed build status. */
@Value.Immutable
@BuckStyleTuple
interface AbstractDistBuildTrackedStatus {
  ...
  int getFinishedRulesCount();

  ImmutableList<CacheRateStatsUpdateEvent> getSlaveCacheStats();
}
