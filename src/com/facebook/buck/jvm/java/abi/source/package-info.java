 ...
 * </p>
 * <p>
 * If the ABI of a dependency target is available, it will be used. However, when one or more
 * dependency ABIs are missing, certain language constructs become ambiguous, and we have
 * to make assumptions. Most of those assumptions can be worked around with small changes to
 * coding style.
 * </p>
 * <p>
