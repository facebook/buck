              ...
              new InterfaceScanner.Listener() {
                ...
                public void onTypeDeclared(TypeElement type, TreePath path) {
                  ...
                  if (implementsClause != null) {
                    ...
                    for (int i = 0; i < implementsClause.size(); i++) {
                      ensureAbsentOrComplete(
                          interfaces.get(i), new TreePath(path, implementsClause.get(i)));
                    }
                  }
                }
                ...
                private Tree getStartOfTypeExpression(Tree leaf) {
                  ...
                  while (startOfTypeExpression.getKind() == Tree.Kind.MEMBER_SELECT) {
                    startOfTypeExpression =
                        ((MemberSelectTree) startOfTypeExpression).getExpression();
                  }
                ...
                private void findMissingDependenciesImpl(
                    TypeElement type, SortedSet<String> builder) {
                ...
                private void findMissingDependenciesImpl(
                    TypeMirror type, SortedSet<String> builder) {
