...
public class PrebuiltJar extends AbstractBuildRuleWithDeclaredAndExtraDeps
  ...
  public ImmutableList<Step> getBuildSteps(
    ...
    AbsPath resolvedCopiedBinaryJar = getProjectFilesystem().resolve(copiedBinaryJar);
    Preconditions.checkState(
        !resolvedBinaryJar.equals(resolvedCopiedBinaryJar.getPath()),
    ...
    if (resolver.getFilesystem(binaryJar).isDirectory(resolvedBinaryJar)) {
      ...
      steps.add(
          CopyStep.forFile(getProjectFilesystem(), resolvedBinaryJar, copiedBinaryJar.getPath()));
    }
