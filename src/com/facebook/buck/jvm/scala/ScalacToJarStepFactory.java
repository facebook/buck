...
public class ScalacToJarStepFactory extends CompileToJarStepFactory implements AddsToRuleKey {
  ...
  private static final PathMatcher JAVA_PATH_MATCHER = new LegacyGlobMatcher("**.java");
  private static final PathMatcher SCALA_PATH_MATCHER = new LegacyGlobMatcher("**.scala");
