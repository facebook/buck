...
public interface FileParsePipeline<T extends FileManifest> extends AutoCloseable {
   ...
   */
  default T getFile(Cell cell, ForwardRelPath buildFile) throws BuildFileParseException {
    try {
   ...
   * @return future.
   */
  ListenableFuture<T> getFileJob(Cell cell, ForwardRelPath buildFile) throws BuildTargetException;
}
