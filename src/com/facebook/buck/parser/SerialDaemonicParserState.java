 ...
 */
class SerialDaemonicParserState implements DaemonicParserState {
  private static final Logger LOG = Logger.get(SerialDaemonicParserState.class);
  ...
  public SerialDaemonicParserState(
