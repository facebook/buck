...
def java_library(
  ...
  add_rule({
    ...
    'annotation_processor_only' : annotation_processor_only,
    'annotation_processor_params' : annotation_processor_params,
    'postprocess_classes_commands' : postprocess_classes_commands,
    'source' : source,
    'target' : target,
...
def robolectric_test(
  ...
  add_rule({
    ...
    'annotation_processor_params' : annotation_processor_params,
    'postprocess_classes_commands' : postprocess_classes_commands,
    'test_library_project_dir' : test_library_project_dir,
    'source_under_test' : source_under_test,
    'contacts' : contacts,
    'deps' : deps,
    'visibility' : visibility,
