...
public interface PerBuildState extends AutoCloseable{
  TargetNode<?> getTargetNode(BuildTarget target)
  ...
  @Override
  void close() throws InterruptedException, BuildFileParseException;
}
