...
public abstract class GetTargetNodeEvent extends AbstractBuckEvent {
  ...
  protected GetTargetNodeEvent(BuildTarget buildTarget) {
    super(EventKey.of("GetTargetNodeEvent", buildTarget));
  ...
  public static class Started extends GetTargetNodeEvent {
    ...
    public String getEventName() {
      return "GetTargetNodeStarted";
    }
  }

  public static class Finished extends GetTargetNodeEvent {
