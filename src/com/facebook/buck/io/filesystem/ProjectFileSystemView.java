...
public interface ProjectFileSystemView {
  ...
  /**
   * @param rootRelativeToCurrentRoot the new root relative to the current root
   * @param additionalIgnores new ignored paths in addition to the current ignores
   * @return a new View based on the current view
   */
  ProjectFileSystemView withView(
      Path rootRelativeToCurrentRoot, ImmutableSet<PathMatcher> additionalIgnores);
