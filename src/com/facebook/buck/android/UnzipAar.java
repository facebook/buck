...
public class UnzipAar extends AbstractBuildRule
  ...
  UnzipAar(
    ...
    this.copiedAar = BuildTargets.getGenPath(getBuildTarget(), "%s.aar");
  }
  ...
  public ImmutableList<Step> getBuildSteps(
    ...
    // Create a copy of the AAR in case it was generated by another rule.
    Path resolvedBinaryJar = getResolver().getPath(aarFile);
    steps.add(new MkdirStep(getProjectFilesystem(), copiedAar.getParent()));
    steps.add(CopyStep.forFile(getProjectFilesystem(), resolvedBinaryJar, copiedAar));
    buildableContext.recordArtifact(copiedAar);
