...
class AndroidBinaryBuildable implements AddsToRuleKey {
  ...
  static class NonPreDexedDexBuildable implements AddsToRuleKey {
    ...
    public DexFilesInfo addDxSteps(
        BuildableContext buildableContext,
        BuildContext buildContext,
        ImmutableList.Builder<Step> steps) {
     ...
     * obfuscated jar files if proguard is used). If split dex is used, multiple dex artifacts will
     * be produced.
     *
     ...
     * @param secondaryDexDirectories The contract for updating this builder must match that of
     *     {@link PreDexMerge#getSecondaryDexSourcePaths()}.
