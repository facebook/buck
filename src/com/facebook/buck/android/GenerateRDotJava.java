...
public class GenerateRDotJava extends AbstractBuildRule {
  ...
  @AddToRuleKey
  private final SourcePath pathToRDotTxtFile;
  @AddToRuleKey
  private Optional<String> resourceUnionPackage;
  @AddToRuleKey
  private boolean shouldBuildStringSourceMap;
  ...
  GenerateRDotJava(
    ...
    this.resourceDeps = resourceDeps.stream()
  ...
  private static ImmutableSortedSet<BuildRule> getAllDeps(
    ...
    builder
        .addAll(ruleFinder.filterBuildRuleInputs(pathToRDotTxtFile))
        .addAll(resourceDeps);
