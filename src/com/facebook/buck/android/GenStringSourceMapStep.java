...
public class GenStringSourceMapStep extends AbstractExecutionStep {
   ...
   * GenRDotTxtStep) and it's originating strings.xml file (path).
   *
   ...
   *     that was provided to {@code aapt} during GenRDotTxtStep.
  ...
  public int execute(ExecutionContext context) {
    // Read the R.txt file that was generated by aapt during GenRDotTxtStep.
