...
public class PackageStringAssets extends AbstractBuildable
  ...
  public static class Builder extends AbstractBuildable.Builder {
    ...
    public Builder setFilteredResourcesProvider(FilteredResourcesProvider resourcesProvider) {
      this.filteredResourcesProvider = resourcesProvider;
      return this;
    }
    ...
    protected BuildRuleType getType() {
      return BuildRuleType.PACKAGE_STRING_ASSETS;
    }

    @Override
    protected Buildable newBuildable(
        BuildRuleParams params, BuildRuleResolver resolver) {
      return new PackageStringAssets(getBuildTarget(), filteredResourcesProvider, uberRDotJava);
    }
  }
}
