...
abstract class GoDescriptors {
  ...
  static GoSymlinkTree requireDirectSymlinkTreeRule(BuildRuleParams sourceParams, BuildRuleResolver resolver) {
  ...
  private static ImmutableSortedSet<BuildRule> getDepTransitiveClosure(final BuildRuleParams params) {
  ...
  static GoSymlinkTree requireTransitiveSymlinkTreeRule(final BuildRuleParams sourceParams, BuildRuleResolver resolver) {
  ...
  static GoLibrary createGoLibraryRule(
      BuildRuleParams params, BuildRuleResolver resolver, GoBuckConfig goBuckConfig, Path packageName,
      ImmutableSet<SourcePath> srcs, List<String> compilerFlags) {
