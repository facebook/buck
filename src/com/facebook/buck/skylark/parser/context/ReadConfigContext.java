...
public class ReadConfigContext {
  ...
  public static ReadConfigContext getContext(StarlarkThread env, FuncallExpression ast)
    ...
    if (value == null) {
      ...
      throw new EvalException(ast.getLocation(), "Context is not set for read_config function.");
    }
    return value;
  }
