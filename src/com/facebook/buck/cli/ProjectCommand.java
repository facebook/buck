...
public class ProjectCommand extends AbstractCommandRunner<ProjectCommandOptions> {
   ...
   * IntelliJ.
   */
  private static final RuleJsonPredicate annotationPredicate = new RuleJsonPredicate() {
    @Override
  ...
  private static final AssociatedRulePredicate associatedProjectsPredicate =
  ...
  ImmutableList<String> getAnnotationProcessingTargets(ProjectCommandOptions options)
    ...
    return ImmutableList.copyOf(
        Iterables.transform(
            createPartialGraph(annotationPredicate,
