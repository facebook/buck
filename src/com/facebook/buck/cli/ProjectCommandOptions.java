...
import static com.facebook.buck.java.intellij.JavaProjectBuckConfig.getJavaConfigTokens;

import com.facebook.buck.java.JavaPackageFinder;
import com.facebook.buck.java.intellij.AndroidBuckConfig;
import com.facebook.buck.java.intellij.JavaProjectBuckConfig;
...
public class ProjectCommandOptions extends BuildCommandOptions {
  ...
  public AndroidBuckConfig getDefaultAndroidConfig() {
    Map<String, Optional<String>> configValues = getBuckSectionValues(
        "project",
  ...
  private Map<String, Optional<String>> getBuckSectionValues(
      String sectionName,
  ...
  public boolean isAndroidAutoGenerateDisabled() {
    ...
    return getBuckConfig().getBooleanValue(
        "project", "disable_r_java_idea_generator",
