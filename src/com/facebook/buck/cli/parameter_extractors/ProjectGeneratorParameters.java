...
public interface ProjectGeneratorParameters extends CommandRunnerParameters {
  ...
  /* TODO(shemitz) The --with-tests and --without-tests switches are incoherent, and probably
  reflect nothing more than archaeology. They should be cleaned up. */
  boolean isWithoutTests();
