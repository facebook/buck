 ...
 * dx --dex.
 */
public class SplitZipCommand implements Command {
  ...
  public SplitZipCommand(
    ...
    this.requiredInPrimaryZip = new Predicate<String>() {
      ...
      public boolean apply(String name) {
        ...
        for (String substr : SplitZipCommand.this.primaryDexSubstrings) {
  ...
  static void writeMetaList(BufferedWriter writer, Collection<File> jarFiles) throws IOException {
    for (File secondary : jarFiles) {
      String filename = SmartDexingCommand.transformInputToDexOutput(secondary.getName());
