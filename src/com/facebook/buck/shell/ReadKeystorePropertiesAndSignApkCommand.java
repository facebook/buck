...
public class ReadKeystorePropertiesAndSignApkCommand extends ShellCommand {
  ...
  /** This will be initialized during {@link #setup(ExecutionContext)}. */
  private SignApkCommand signApkCommand;

  public ReadKeystorePropertiesAndSignApkCommand(
  ...
  public void setup(ExecutionContext context) throws IOException {
    ...
    this.signApkCommand = new SignApkCommand(outputPath,
        unsignedApk,
  ...
  @VisibleForTesting
  SignApkCommand getSignApkCommand() {
