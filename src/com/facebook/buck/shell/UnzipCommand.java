...
public class UnzipCommand extends ShellCommand {
  ...
  /**
   * Creates an {@link UnzipCommand} that extracts an entire .zip archive.
  ...
  /**
   * Creates an {@link UnzipCommand} that extracts only specific files from a .zip archive.
   * Example:
   * <pre>
