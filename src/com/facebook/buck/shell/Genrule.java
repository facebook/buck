...
public class Genrule extends AbstractBuildRule
  ...
  void addSymlinkCommands(ImmutableList.Builder<Step> commands) {
    ...
    for (SourcePath src : srcs) {
      ...
      // Form the destination using the source path "name".
      String name = getResolver().getSourcePathName(getBuildTarget(), src);
      Path destination = pathToSrcDirectory.resolve(name);
