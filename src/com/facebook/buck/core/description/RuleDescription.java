...
public interface RuleDescription<T extends BuildRuleArg> extends Description<T> {
   ...
   * the propagated {@link com.facebook.buck.skylark.function.packages.Provider}s and corresponding
   * {@link com.facebook.buck.skylark.function.packages.Info}s, and register its corresponding
   * actions.
   *
   ...
   *     com.facebook.buck.skylark.function.packages.Provider} and {@link
   ...
   *     com.facebook.buck.skylark.function.packages.Provider} and the corresponding {@link
   *     com.facebook.buck.skylark.function.packages.Info} to be propagated by this rule.
