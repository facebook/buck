...
/**
 * Delegates the actual reading of disk-cached data to the {@link
 * com.facebook.buck.core.rules.attr.InitializableFromDisk} and is responsible for safely storing
...
public final class BuildOutputInitializer<T> {
   ...
   * #initializeFromDisk(SourcePathResolverAdapter)}.
   *
   * <p>
   *
