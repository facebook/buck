...
@BuckStyleValue
public abstract class UnconfiguredSourceWithFlags {
  ...
  /** Apply configuration this unconfigured source with flags. */
  public SourceWithFlags configure(
    ...
    return SourceWithFlags.of(
        ...
        getFlags().stream()
            .map(flag -> flag.configure(targetConfiguration, hostConfigurationResolver))
