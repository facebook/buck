...
public enum EventKind {
   ...
   * attempt to start or continue a build if an error is encountered (though the behaviour specified
   * by --keep-going flag is a counterexample).
   *
  ...
  public static final Set<EventKind> ALL_EVENTS = EnumSet.allOf(EventKind.class);

  public static final Set<EventKind> OUTPUT = EnumSet.of(EventKind.STDOUT, EventKind.STDERR);

  public static final Set<EventKind> ERRORS =
      EnumSet.of(EventKind.ERROR, EventKind.FAIL, EventKind.TIMEOUT);

  public static final Set<EventKind> ERRORS_AND_WARNINGS =
      EnumSet.of(
          EventKind.ERROR, EventKind.WARNING, EventKind.DEBUG, EventKind.FAIL, EventKind.TIMEOUT);

  public static final Set<EventKind> ERRORS_WARNINGS_AND_INFO =
      EnumSet.of(
          EventKind.ERROR,
          EventKind.WARNING,
          EventKind.DEBUG,
  ...
  public static final Set<EventKind> ERRORS_AND_OUTPUT =
      EnumSet.of(
          EventKind.ERROR, EventKind.FAIL, EventKind.TIMEOUT, EventKind.STDOUT, EventKind.STDERR);

  public static final Set<EventKind> ERRORS_AND_WARNINGS_AND_OUTPUT =
      EnumSet.of(
          EventKind.ERROR,
          EventKind.WARNING,
          EventKind.DEBUG,
  ...
  public static final Set<EventKind> ERRORS_WARNINGS_AND_INFO_AND_OUTPUT =
      EnumSet.of(
          EventKind.ERROR,
          EventKind.WARNING,
          EventKind.DEBUG,
