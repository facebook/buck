...
public interface BuildFileTree {
   ...
   */
  Optional<ForwardRelPath> getBasePathOfAncestorTarget(ForwardRelPath filePath);

  /** Rel-path version of {@link #getBasePathOfAncestorTarget(ForwardRelPath)}. */
  default Optional<RelPath> getBasePathOfAncestorTarget(RelPath filePath) {
    if (filePath.startsWith("..")) {
      return Optional.empty();
    }
    return getBasePathOfAncestorTarget(ForwardRelPath.ofRelPath(filePath))
