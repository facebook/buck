...
public final class LabelValidator {
   ...
   * @return null if {@code name} is valid or an error string if any part of the package name is
   *     invalid
   */
  @Nullable
   ...
   */
  public static PackageAndTarget parseAbsoluteLabel(String absName)
      throws LabelValidator.BadLabelException {
