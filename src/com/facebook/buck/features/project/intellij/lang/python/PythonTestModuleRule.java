...
public class PythonTestModuleRule extends BaseIjModuleRule<PythonTestDescriptionArg> {

  public PythonTestModuleRule(
  ...
  public Class<? extends DescriptionWithTargetGraph<?>> getDescriptionClass() {
    return PythonTestDescription.class;
  }

  @Override
  public void apply(TargetNode<PythonTestDescriptionArg> target, ModuleBuildContext context) {
