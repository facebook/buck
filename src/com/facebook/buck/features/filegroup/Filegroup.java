    ...
    if (srcs.isPresent()) {
      ...
      actualSrcs.match(
          new SourceSet.Matcher<>() {
            @Override
            public Void named(ImmutableMap<String, SourcePath> named) {
            ...
            @Override
            public Void unnamed(ImmutableSet<SourcePath> unnamed) {
              bundler.copy(
                  filesystem,
                  buildCellPathFactory,
                  steps,
      ...
      // Surprisingly, but empty filegroup is supported
      bundler.copy(
          filesystem,
          buildCellPathFactory,
          steps,
