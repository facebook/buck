...
class CompilerXml {
  ...
  private final List<SerializableModule> modules;

  CompilerXml(ProjectFilesystem filesystem, List<SerializableModule> modules) {
    ...
    Collections.sort(modules, SerializableModule.BUILDTARGET_NAME_COMARATOR);
  }
  ...
  private ImmutableSet<String> getTopLevelExcludeDirs() {
    return ImmutableSet.of(
        IjAndroidHelper.getAndroidGenDir(filesystem),
