...
public class RunShTestAndRecordResultCommand implements Command {

  private String pathToShellScript;
  private String pathToTestResultFile;

  public RunShTestAndRecordResultCommand(String pathToShellScript, String pathToTestResultFile) {
