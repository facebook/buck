...
/** Unconfigured version of {@link CxxppFlagsMacro}. */
@BuckStyleValue
public abstract class UnconfiguredCxxppFlagsMacro
    extends UnconfiguredCxxGenruleFilterAndTargetsMacro {

  public static UnconfiguredCxxppFlagsMacro of(
      Optional<Pattern> pattern,
      ImmutableList<UnconfiguredBuildTargetWithOutputs> targetsWithOutputs) {
    return ImmutableUnconfiguredCxxppFlagsMacro.ofImpl(pattern, targetsWithOutputs);
  }

  @Override
  public Class<? extends UnconfiguredMacro> getUnconfiguredMacroClass() {
    return UnconfiguredCxxppFlagsMacro.class;
  }
