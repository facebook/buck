...
public abstract class CppFlagsMacro extends CxxGenruleFilterAndTargetsMacro {
  ...
  @Override
  CppFlagsMacro withTargetsWithOutputs(ImmutableList<BuildTargetWithOutputs> targetsWithOutputs) {
  ...
  public static CppFlagsMacro of(
    ...
    return ImmutableCppFlagsMacro.ofImpl(pattern, targetsWithOutputs);
  }
}
