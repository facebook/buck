...
@BuckStyleValue
public abstract class LdflagsSharedFilterMacro extends CxxGenruleFilterAndTargetsMacro {

  @Override
  public Class<? extends Macro> getMacroClass() {
    return LdflagsSharedFilterMacro.class;
  }

  @Override
  LdflagsSharedFilterMacro withTargetsWithOutputs(
  ...
  public static LdflagsSharedFilterMacro of(
    ...
    return ImmutableLdflagsSharedFilterMacro.ofImpl(pattern, targetsWithOutputs);
  }
}
