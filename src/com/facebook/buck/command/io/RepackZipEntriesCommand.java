 ...
 */
public class RepackZipEntriesCommand extends CompositeCommand {

  private static List<ShellCommand> createSubCommands(
      String inputFile,
      String outputFile,
    ...
    ShellCommand unzip = new UnzipCommand(
        inputFile,
    ...
    ShellCommand zip = new ZipCommand(
        ZipCommand.Mode.ADD,
  ...
  /**
   * Creates a {@link RepackZipEntriesCommand}.
   ...
   */
  public RepackZipEntriesCommand(
      String inputFile,
      String outputFile,
      ImmutableSet<String> entries,
      int compressionLevel,
  ...
  /**
   * Creates a {@link RepackZipEntriesCommand}. A temporary directory will be created and used
  ...
  public RepackZipEntriesCommand(
      ...
      String outputFile,
      ImmutableSet<String> entries) {
    this(inputFile, outputFile, entries, ZipCommand.MAX_COMPRESSION_LEVEL, null);
  }
