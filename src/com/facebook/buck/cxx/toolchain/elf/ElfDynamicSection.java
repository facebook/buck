...
public class ElfDynamicSection {
  ...
  public enum DTag {
    ...
    DT_RELRSZ(35, Type.OTHER),
    DT_RELR(36, Type.OTHER),
    DT_RELRENT(37, Type.OTHER),
    // Android compressed relocations
    DT_ANDROID_REL(0x6000000f, Type.OTHER),
    DT_ANDROID_RELSZ(0x60000010, Type.OTHER),
    DT_ANDROID_RELA(0x60000011, Type.OTHER),
    DT_ANDROID_RELASZ(0x60000012, Type.OTHER),
    // Android-scoped RELR
    DT_ANDROID_RELR(0x6fffe000, Type.OTHER),
    DT_ANDROID_RELRSZ(0x6fffe001, Type.OTHER),
    DT_ANDROID_RELRENT(0x6fffe003, Type.OTHER),
    DT_ANDROID_RELRCOUNT(0x6fffe005, Type.OTHER),
