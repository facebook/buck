...
/** Archiver implementation for llvm-ar. */
public class LlvmArchiver extends DelegatingTool implements Archiver {
  public LlvmArchiver(Tool tool) {
    super(tool);
  }
  ...
  public ImmutableList<String> getArchiveOptions(boolean isThinArchive) {
    String options = isThinArchive ? "qcsT" : "qcs";
