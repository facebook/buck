...
public class CxxPreprocessorFlags {
  ...
  public static ImmutableMultimap<CxxSource.Type, String> fromArgs(
      ImmutableList<String> defaultFlags,
      ImmutableMap<CxxSource.Type, ImmutableList<String>> perLanguageFlags
  ) {
