...
class Label(collections.namedtuple('Label', ['cell', 'package', 'name'])):
    """
    Identifies a build target. All build targets belong to exactly one package and their names are
    called their labels. Examples of labels: //dir1/dir2:target_name where 'dir1/dir2' is the
    package containing a build file, and 'target_name' represents the target within the package.
    """
    def get_build_file_path(self, cell_roots: typing.Dict[str, str],
