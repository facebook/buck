...
public class BuckRunConfigurationTest extends BuckTestCase {

  public void testPersistency() throws Exception {
    final ConfigurationFactory factory =
        BuckRunConfigurationType.getInstance().getConfigurationFactories()[0];
    final BuckRunConfiguration cfg =
        new BuckRunConfiguration(getProject(), factory, "test serialization");
    ...
    final BuckRunConfiguration cfg2 =
        new BuckRunConfiguration(getProject(), factory, "test serialization");
  ...
  public void testAllFieldsPublic() throws Exception {
    final Field[] fs = BuckRunConfiguration.Data.class.getDeclaredFields();
    for (Field f : fs) {
