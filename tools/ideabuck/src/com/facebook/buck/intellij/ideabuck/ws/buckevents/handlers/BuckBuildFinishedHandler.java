...
public class BuckBuildFinishedHandler implements BuckEventHandler {
  @Override
  public void handleEvent(
    ...
    buckEventsConsumerFactory.getBuildEndConsumer().consumeBuildEnd(event.getTimestampMillis());
  }
}
