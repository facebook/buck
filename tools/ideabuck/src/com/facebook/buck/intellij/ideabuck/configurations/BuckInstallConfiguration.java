...
public class BuckInstallConfiguration
    extends AbstractConfiguration<BuckInstallConfiguration.InstallData> {

  protected BuckInstallConfiguration(
  ...
  public SettingsEditor<? extends RunConfiguration> getConfigurationEditor() {
    return new BuckInstallConfigurationEditor(getProject());
  }
  ...
  @Override
  protected InstallData createData() {
