 ...
 *
 * @see <a href=https://dev.buck.build/concept/build_target_pattern.html">the Buck documentation for
...
public class BuckTargetPattern {
  ...
  // Based on regex from https://dev.buck.build/concept/build_target.html,
