...
public class SoyTemplateSkylarkSignatureRenderer {
   ...
   */
  public String render(StarlarkMethod skylarkSignature) {
  ...
  public String renderTableOfContents(Iterable<StarlarkMethod> signatures) {
    ...
    stringTemplate.add(
        ...
        Streams.stream(signatures)
            .sorted(Comparator.comparing(StarlarkMethod::name))
  ...
  private static ImmutableMap<String, Object> toMap(StarlarkMethod skylarkSignature) {
